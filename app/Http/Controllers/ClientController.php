...
class ClientController extends Controller
{
    ...
    public function index()
    {
        ...
        // return$clients = Client::with(['payment' => fn ($q) => $q->select(['id','client_id','status','is_expire'])])        
        //     // ->orderBy('payment.is_expire','asc')        
        //     ->get(['id', 'company', 'first_name', 'last_name', 'email', 'phone']);
