...
class DesposalController extends Controller
{
    public function getAsset(Request $request)
    {
        ...
        foreach ($disposals as $disposal) {
            $list .= view('frontend.accounts.depreciation.disposal.disposal_list', [
                'get'      => 'list',
    ...
    public function getModal(Request $request)
    {
        ...
        $modal .= view('frontend.accounts.depreciation.disposal.disposal_list', [
            'get'         => 'modal',
            'disposal'    => $disposal,
    ...
    public function getAmount(Request $request, DepAssetName $asset_name)
    {
    ...
    public function postAsset(Request $request, DepAssetName $asset)
    {
        // return $request;
        $request->validate([
