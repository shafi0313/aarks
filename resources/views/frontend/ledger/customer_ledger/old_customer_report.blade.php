                            ...
                            <div align="center">
                                ...
                                <table class="table table-bordered table-sm">
                                    <tbody>
                                        ...
                                        @php $balance += $dedotr->sum('amount'); @endphp
                                        <tr>
                                            <td align="center">{{$dedotr->first()->tran_date->format('d/m/Y')}}</td>
                                            <td align="center">
                                                <a href="{{route('inv.report',[$layout,$dedotr->first()->inv_no,$client->id,$cId->id])}}">
                                                    {{client()->invoiceLayout}} {{invoice($dedotr->first()->inv_no, 8, 'INV')}}
                                                </a>
                                            </td>
                                            <td align="center">{{number_format($dedotr->sum('amount'),2)}}</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                $ {{number_format(($dedotrs->sum('amount') + $cId->opening_blnc) - $payment_amount,2)}}
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
