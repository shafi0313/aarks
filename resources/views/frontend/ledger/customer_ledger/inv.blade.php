            ...
            <div class="col-md-9">
                ...
                <div class="row" style="border:2px solid #666666; min-height:600px; background:#FFFFFF; padding:10px">
                    ...
                    <div class="col-md-7" style="padding-left:0px;">
                        <div class="">
                            <div >
                                <strong style="font-size:20px;">{{$dedotr->client->company? $dedotr->client->company: $dedotr->client->first_name .' '. $dedotr->client->last_name}}</strong><br>
                        ...
                        <div class="row">
                            <div class="col-md-5 " align="left">
                                ...
                                <div class="col-md-12 left_billingaddress">
                                    ...
                                    <strong style="font-size:20px;">{{$dedotr->customer->name}}</strong><br>
