                    ...
                    <div class="col-md-7" style="padding-left:11px;">
                        <div class="">
                            <div style="padding:5px;">
                                <strong style="font-size:20px;">Focus Taxation and Accounting Pty Ltd</strong><br>
                    ...
                    <div class="col-md-5" align="center">
                        <div class="row" style="padding-top:20px;">
                            <div class="col-md-12" align="right">
                                <img src="https://aarks.net.au/upload/logo/1498024984.jpg" class="img-responsive"
                        ...
                        <table width="100%" cellpadding="2" class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">{{number_format($dedotrs->sum('amount'),2)}}</td>
                                </tr>
                                <tr>
