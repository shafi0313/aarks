...
@section('title', 'Consolidation GST/BAS Report')
@section('content')
<?php $p="cbs"; $mp="advr";?>
<!-- Page Content Start -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-heading">
                        <h3> GST/BAS Consolidation Cash Select Date</h3>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        <ul>
                        ...
                        @endif
                        <form action="{{route('client_cash_basis.report')}}" method="get" autocomplete="off">
