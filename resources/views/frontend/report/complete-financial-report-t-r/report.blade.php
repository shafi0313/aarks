            ...
            <div class="col-lg-12">
                ...
                <div class="row justify-content-center"
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <h2>FINANCIAL REPORT T FORM</h2>
                        <h3 style="border-bottom:1px solid black;display:inline-block; padding-bottom:2px;margin:0">For
                            the year ended {{$data['date']->format('d-M-Y')}}</h3>
                        <br>
                        <br>
                        <h4>Prepared by <br>
                            {{$client->agent_name}}
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <p><b>Powered by <a href="https://aarks.com.au">AARKS</a> <a
