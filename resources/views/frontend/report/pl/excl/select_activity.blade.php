...
@section('title', 'Profit & Loss Exclusive Final Report')
@section('content')
<?php $p="pexcl"; $mp="report";?>
<!-- Page Content Start -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-heading">
                        <h3>Profit & Loss Exclusiv Final Report Select Date</h3>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        <ul>
                        ...
                        @endif
                        <form action="{{route('excl.report')}}" method="get" autocomplete="off">
