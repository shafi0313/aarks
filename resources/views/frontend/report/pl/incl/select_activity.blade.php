...
@section('title', 'Profit & Loss Inclusive Final Report Select Date')
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-heading">
                        <h3>Profit & Loss Inclusive Final Report Select Date</h3>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        <ul>
                        ...
                        @endif
                        <form action="{{route('incl.report')}}" method="get" autocomplete="off">
