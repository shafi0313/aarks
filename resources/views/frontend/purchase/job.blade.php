<div class="row mx-auto">
    ...
    <div class="form-group mx-1" style="width: 100px">
        ...
        <input class="form-control form-control-sm" type="Number" name="price" id="price" placeholder="Price">
    </div>
    <div class="form-group mx-1" style="width: 100px">
        <label>Disc %: </label>
        <input class="form-control form-control-sm" type="Number" name="disc_rate" id="disc_rate" placeholder="Disc %">
    </div>
    <div class="form-group mx-1" style="width: 120px">
        <label>Freight Charge: </label>
        <input class="form-control form-control-sm" type="Number" name="freight_charge" id="freight_charge" @if (!$chkOverhead) readonly title="Freight Charge Not Available" @endif>
    </div>
    ...
    <div class="form-group mx-1" style="width:70px">
        <label>Tax: </label>
        <input type="text" name="is_tax" id="is_tax" readonly value class="form-control form-control-sm">
    </div>
