                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('service_order.edit',$creditors->first()->inv_no)}}"
                                                    class="btn btn-warning btn-sm">
                                                    <i class="far fa-edit"></i> Edit
                                                </a>
                                                <form action="{{route('service_order.convertStore',$creditors->first()->inv_no)}}" method="POST">
                                                    @csrf
                                                    <button type="submit" class="btn btn-info btn-sm">
                                                    <i class="fas fa-exchange-alt"></i> CONVERT</button>
                                                </form>
                                            </td>
                                        </tr>
                                    </tfoot>
