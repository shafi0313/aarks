                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="col-md-12" style="padding-top:5px;">
                                <div align="left"><strong>Order Details :</strong></div>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">{{ number_format($invoices->sum('freight_charge'), 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>GST </td>
                                            {{-- <td>{{number_format($invoices->sum('disc_amount'),2)}}</td> --}}
                                            <td class="text-right">{{ number_format($invoices->sum('amount') - $invoices->sum('freight_charge') - $invoices->sum('price'), 2) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>TOTAL</td>
