                            ...
                            <div class="col-md-9">
                                <div class="row justify-content-end">
                                    <div class="col-3 form-group">
                                        <input class="form-control datepicker" data-date-format="mm/dd/yyyy" name=""
                        ...
                        <table id="example" class="table table-striped table-bordered table-hover display table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action">
                                            <a href="{{route('spayment.report',$invoice->id)}}" class="btn btn-success btn-sm">
                                                <i class="fas fa-print fa-lg"></i>
                                            </a>
                                            <a href="{{route('spayment.mailReport',$invoice->id)}}" class="btn btn-info btn-sm">
                                                <i class="fas fa-envelope fa-lg"></i>
                                            </a>
                                            <form action="{{route('spayment.destroy',$invoice->id)}}" method="post"
