        ...
        <table border="1" cellpadding="0" cellspacing="0" width="100%"
                ...
                <td height="0" style="border: 0px solid #fff;" border="0" valign="top">
                    <table width="100%" border="0" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td align="center"
                                style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 10pt;">
                                {{$invoice->item_name}}</td>
                            <td align="center"
                                style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 10pt;">
                                {{$invoice->item_quantity}}</td>
                            <td align="center"
                                style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 10pt;">
                                {{number_format($invoice->ex_rate,2)}}</td>
                            <td align="center"
                                style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 10pt;">
            ...
            <tr>
                <td>
                    <table border="0" cellpadding="5" cellspacing="0" width="100%">
                        <tr>
                            <td width="55%">Please forward your payment to BSB : {{$client->bsb->bsb_number ?? '' }}&nbsp;&nbsp;Account {{$client->bsb->account_number ?? '' }} no  Account Name :
