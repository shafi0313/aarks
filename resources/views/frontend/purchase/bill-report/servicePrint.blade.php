                ...
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td width="100%">
                                <br>
                                <div style="text-align: center; font-size: 20px" ><u>TAX INVOICE</u> </div>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table border="1" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                            ...
                            <td width="45%" border="0" style="border-left:1px solid black;">
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">Total Amount(Without GST)</td>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">{{number_format($invoices->sum('price'),2)}}</td>
                                    </tr>
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">Freight Charge</td>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">{{number_format($invoices->sum('freight_charge'),2)}}</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">{{number_format($invoices->sum('amount') - $invoices->sum('freight_charge') -$invoices->sum('price') ,2)}}</td>
                                    </tr>
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">TOTAL</td>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">{{number_format($invoices->sum('amount'),2)}}</td>
                                    </tr>
                                    <tr>
                                        <td style="border-right:1px solid black;">PAID Amt</td>
                                        <td style="border-right:1px solid black;">{{number_format($invoices->sum('payment_amount'),2)}}</td>
                                    </tr>
            ...
            <tr>
                <td>
                    <table border="0" cellpadding="5" cellspacing="0" width="100%">
                        <tr>
                            <td width="55%">Please forward your payment to BSB : {{optional($client->bsb)->bsb_number}}&nbsp;&nbsp;Account {{optional($client->bsb)->account_number}} no  Account Name :
                            ...
                            <td width="45%" border="0" style="border-left:1px solid black;">
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                        <td>Accepected please Sign here.................</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
            ...
            <tr>
                <td style="text-align:center">Powered by<a href="https://www.aarks.com.au/"> AARKS &nbsp;</a>{{now()->format('Y')}}</td>
            </tr>
        </table>
    </body>
