            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body row">
                        <div class="col-md-4" align="center">
                            <div class="row" style="padding-top:20px;">
                                <div class="col-md-12" align="left">
                                    <img src="{{$client->logo?asset($client->logo):asset('frontend/assets/images/logo/focus-icon.png')}}" class="img-responsive" style="max-width:90px; max-height:90px;">
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{number_format($invoices->sum('amount') - $invoices->sum('freight_charge') -$invoices->sum('price') ,2)}}</td>
                                    </tr>
                                    <tr>
                                        <td>TOTAL</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p>
                                                ...
                                                Please forward your payment to BSB : {{$client->bsb->bsb_number??''}}&nbsp;&nbsp;Account {{$client->bsb->account_number??''}} no  Account Name :
                        ...
                        <div class="col-12">
                            <a href="{{route('bill.report.print', ['item',$inv_no, $client->id])}}"  target="_blank" class="btn btn-outline-info text-dark pull-right btn-lg"> <i class="fa fa-print"></i> PRINT</a>
                        </div>
                    </div>
                </div>
            </div>
