                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-primary">
                                        <a href="{{route('bill.report',['item',$service->first()->inv_no,$client->id])}}">{{invoice($service->first()->inv_no, 8, 'BILL')}}</a>
                                    </td>
                                    ...
                                    <td>
                                        <div class="action">
                                            <a  title="Item Edit" href="{{route('enter_item.billedit',[$service->first()->inv_no,$service->first()->client_id])}}"
