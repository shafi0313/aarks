            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-5">
                                <strong style="color:green; font-size:20px;">Update Services:
                                </strong>
                            </div>
                        </div>
                        <hr>
                        <form action="{{route('service_bill.billupdate',[$service->inv_no,$service->client_id])}}" method="POST" autocomplete="off">
                            @csrf @method('put')
                            @if ($errors->any())
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 form-group">
                                    ...
                                    <input required class="form-control form-control-sm datepicker" type="text" readonly
                                        name="start_date" data-date-format="dd/mm/yyyy"
                                        value="{{$service->tran_date->format('d/m/Y')}}">
                                </div>
                                <div class="col-2 form-group">
