            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <strong style="color:green; font-size:20px;">Invoice Manage: </strong>
                            </div>
                            <div class="col-md-9">
                            ...
                            <table id="example" class="table table-striped table-bordered table-hover display table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('invoice.manage',$quote->first()->customer_card_id)}} " class="btn btn-sm btn-primary">View</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
