<div style="padding-top:0px;">
                ...
                <form id="amount_addForm" action="{{ route('adtperiod.store') }}" method="post"
                    ...
                    <td style="width:10%">
                        ...
                        <input type="number" step="any" id="amount" class="form-control" name="amount"
                            style="width:100%" placeholder=" Amount $" required tabIndex='2'>
                        <div id="msg"></div>
                    </td>
                    @if ($client_account->gst_code == 'GST' || $client_account->gst_code == 'CAP' || $client_account->gst_code == 'INP')
                        <td style="width:8%" id="gstfild">
                            <input class="gst form-control" step="any" type="number" id="gstamt" name="gstamt"
                                style="width:100%" required placeholder=" GST $" tabIndex='3'>
                        </td>
                    ...
                    @else
                        <td style="width:8%" id="gstfild">
                            <input class="gst form-control" type="number" id="gstamt" name="gstamt"
                                style="width:100%" placeholder=" GST $" tabIndex='3' disabled step="any">
                        </td>
                        <td style="width:9%" id="totalinvfild">
                            {{-- <div id="msginv" class=" text-danger" ></div> --}}
                            <input class="totalinv form-control" type="text" id="totalinv" name="totalinv"
                    ...
                    <td style="width:11%" id="balancefiled">
                        <input class="balance form-control" type="text" id="balance" name="balance"
                            style="width:100%" placeholder=" Balance" disabled step="any">
                    </td>
                    <td style="width:10%">
                        <input type="text" id="percentile" name="percentile" style="width:100%"
                            class="form-control" placeholder=" %" tabIndex='5' step="any">
                    </td>
                    <td style="width:40%">
    ...
    <button type="submit" class="valueempty_client " id="date_inv_submit" style="padding:0px; display:none"
        tabIndex='7'></button>
    </form>
</div>
