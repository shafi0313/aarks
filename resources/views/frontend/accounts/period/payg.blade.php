        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6>
                        Add PAYG Installment {{ bdDate($period->end_date) }}
                    </h6>
                ...
                <div class="modal-body row">
                    <div class="col-lg-5">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control payg_percenttige" name="payg_percenttige"
                                id="payg_percenttige" required="required" value="" placeholder="Enter Percentage">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control payg_amount" id="payg_amount" name="payg_amount"
                                placeholder="Enter Amount" required="required" value="">
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header justify-content-center">
                    ...
                    <div class="">
                        <button style="padding: 5px 0 0 0%; margin:0;" type="button" class="close"
