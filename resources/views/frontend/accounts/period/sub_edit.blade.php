                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <select class="form-control chosen-select select2Single" id="subid"
                                            name="subid" onchange="location = this.value">
                                            <option>
                                        ...
                                        <h2 class="pull-left text-light">{{$client_account->name}}</h2>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <table class="scroll table table-bordered table-stipe">
                                                    <div class="col-lg-12"
                                                        style="background: #337ab7;color:white;font-size: 20px">
                                                        ...
                                                        @foreach ($data as $item)
                                                            @if ($item->ac_type == 1)
                                                                <tr>
                                                                    ...
                                                                    <td width="8.8%">
                                                                        {{ $item->total_inv == '' ? 0 : $item->total_inv }}
                                                                    </td>
                                                                    <td width="9.8%">
                                                                        {{ $item->balance == '' ? 0 : abs($item->balance) }}
                                                                    </td>
                                                                    <td width="9.9%">
                                                                    ...
                                                                    <td width="5%">
                                                                        <form
                                                                            action="{{ route('adtperiod.destroy', $item->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
