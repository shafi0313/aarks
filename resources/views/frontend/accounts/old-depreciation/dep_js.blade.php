<script>
    ...
    // });
    readAssetName();
    $('#addAssetName').on('submit', function(e){
        e.preventDefault();
        $.ajax({
            ...
            data: {
                ...
                client_id    : "{{$depreciation->client_id}}",
                profession_id: "{{$depreciation->profession_id}}"
            },
            success: (res)=> {
                readAssetName();
    ...
    function readAssetName(){
        let profession_id = "{{$depreciation->id}}";
        $.ajax({
    ...
    $('#update-modal').on('submit', function(e){
        e.preventDefault();
        $.ajax({
    ...
    $("#rollover_year").on('change', function(){
        ...
        let year          = $(this).val();
        $.get('{{route("client.dep_rollover.get")}}',{
            client_id    : client_id,
    ...
    $("#reinstated_year").on('change', function(){
        ...
        let year          = $(this).val();
        $.get('{{route("client.dep_reinstated.get")}}',{
            client_id    : client_id,
            profession_id: profession_id,
            year         : year,
        },(res)=>{
