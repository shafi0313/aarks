        ...
        <form id="assetupdate" method="POST" autocomplete="off" action="{{route('client.dep_disposal.postAsset',$disposal->id)}}">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="text-dark assetitle">{{$disposal->asset_name}}</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" data-date-format="dd/mm/yyyy" class="form-control datepicker"
                            ...
                            id="disposal_date" placeholder="dd/mm/yyyy" onkeyup="getDisposalAmount(this,{{$disposal->id}}, '{{route("client.dep_disposal.getAmount", $disposal->id)}}')" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select required class="form-control" id="secend_account" name="ac_code[]">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for=""></label>
                                <input type="number" step="any" name="debit[]" id="secend_debit" class="form-control debit" value="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for=""></label>
                                <input type="number" step="any" name="credit[]" id="secend_credit" class="form-control credit" value="{{$disposal->purchase_value}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select required class="form-control" id="thard_account" name="ac_code[]">
                                    <option value="">--Select Account--</option>
                        ...
                        <div class="col-md-3" style="padding-top:8px">
                            <div class="form-group">
                                <label for=""></label>
                                <input type="number" step="any" name="debit[]" id="thard_debit" class="form-control debit thard_input">
                            </div>
                        </div>
                        <div class="col-md-3" style="padding-top:8px">
                            <div class="form-group">
                                <label for=""></label>
                                <input type="number" step="any" name="credit[]" id="thard_credit" class="form-control credit thard_input">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select readonly required class="form-control" id="four_account" name="ac_code[]">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for=""></label>
                                <input type="number" step="any" name="debit[]" id="fourth_debit" class="form-control debit">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for=""></label>
                                <input type="number" step="any" name="credit[]" id="fourth_credit" class="form-control credit">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
$(function() {
    ...
    $(document).on('keyup', '.thard_input',function(e){
        $("#fourth_debit").val(0);
        $("#fourth_credit").val(0);
        let debit = $(".debit");
        let credit = $(".credit");
        ...
        if(sum_credit != sum_debit) {
            ...
            if(net_amt > 0) {
                $("#fourth_debit").val('');
                $("#fourth_credit").val(Math.abs(net_amt).toFixed(2));
            } else{
                $("#fourth_debit").val(Math.abs(net_amt).toFixed(2));
                $("#fourth_credit").val('');
            }
            sum_cal();
        }
