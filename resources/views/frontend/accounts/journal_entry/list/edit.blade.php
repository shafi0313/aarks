...
@section('title','Client Journal List')
@section('content')
                        ...
                        <div style="margin: 5px">
                            <div class="row" style="padding-bottom: 10px;">
                                ...
                                <div class="form-group row form-group-sm">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="text" disabled class="form-control" value="{{$journal->journal_number}}">
                                    </div>
                                </div>
                                <div class="form-group row form-group-sm">
                            ...
                            <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <table class="tbl">
                                        ...
                                        <form action="{{route('client.jl_update',$journal->id)}}" method="POST">
                                        @csrf @method('put')
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                @if ($jnl->is_edited == 1)
                                                <a title="Jounal List Delete" data-id="{{$jnl->id}}" onclick="return confirm('are you sure?')" class="red" id="delete" href="{{route('client.je_delete', $jnl->id)}}"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
...
<script>
    ...
    $('table tbody tr').find('.idebit,.icredit').on('keyup',function() {
    ...
    $('#add').click(function () {
        ...
        request.done(function( response ) {
            clear();
            alert( 'Journal Code added success!')
            $('#debit').prop('disabled',false);
            $('#credit').prop('disabled',false);
            location.reload();
        });
