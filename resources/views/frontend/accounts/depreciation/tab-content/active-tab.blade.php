    ...
    <div class="thumbnail" style="padding: 20px; min-height: 600px;">
        <div class="row" style="padding:0px 50px 0px 50px;">
            ...
            <div class="col-md-6">
                ...
                <div class="" style="border: 1px solid #000000; padding: 10px;">
            ...
            <div class="col-md-6">
                ...
                <div class="" style="border: 1px solid #000000; padding: 10px; min-height:235px;">
                    <div class="form-group form-row">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12" style="padding-top:10px;">
                    <div class="form-group form-row loading" style="text-align:center; display:none;">
