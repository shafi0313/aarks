                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('upgradeRequest') }}" method="POST" enctype="multipart/form-data"
                                autocomplete="off">
                                @csrf
                                ...
                                <div class="row justify-content-center">
                                    <div class="form-group file_upload">
                                        ...
                                        <div class="upload" data-target="#rcpt" data-type="rcpt">
                                            ...
                                            <img src='' alt=".." style="display:none" id='blah'
                                                class='img-fluid' />
                                        </div>
                                        <input required type="file" name="rcpt" id="my_file" style="display: none;"
                                            accept="image/*" />
                                    </div>
                                </div>
