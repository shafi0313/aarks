            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <strong style="color:green; font-size:20px;">Edit/Print/Email Quotes</strong>
                            </div>
                            <div class="col-md-9">
                                <form action="{{route('edit.print.filter')}}" method="get" autocomplete="off">
                                    <input type="hidden" name="src" value="quote">
                                    <div class="row justify-content-end">
                                        <div class="col-3 form-group">
                                            <input class="form-control datepicker" data-date-format="dd/mm/yyyy"
                                                name="start_date" value="{{request()->start_date}}" placeholder="From Date">
                                        </div>
                                        <div class="col-3 form-group">
                                            <input class="form-control datepicker" data-date-format="dd/mm/yyyy"
                                                name="end_date" value="{{request()->end_date}}" placeholder="To Date">
                                        </div>
                                        <div class="mr-3">
                        ...
                        <table id="example" class="table table-striped table-bordered table-hover display table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action">
                                            <a title="Quote Edit" href="{{route('quote.edit',$quote->first()->inv_no)}}"
                                                class="btn btn-info btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{route('quote.destroy',$quote->first()->id)}}" method="post"
                                                style="display: inline">
                                                @csrf @method('delete')
                                                <button title="Quote Delete" type="submit" class="btn btn-sm btn-danger"
