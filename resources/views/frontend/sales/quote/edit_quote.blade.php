            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-5">
                                <strong style="color:green; font-size:20px;">Edit/Print/Email Quote:
                                </strong>
                            </div>
                        </div>
                        <hr>
                        <form action="{{route('quote.update',$quote->id)}}" method="POST" autocomplete="off">
                            @csrf @method('put')
                            <input type="hidden" name="client_id" value="{{$client->id}}">
                            <input type="hidden" name="source" value="quote">
                            <input type="hidden" name="profession_id" value="{{$quote->profession_id}}">
                            @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="col-2 form-group">
                                    ...
                                    <select required class="form-control  form-control-sm" name="customer_card_id">
                                        ...
                                        <option {{$quote->customer_card_id == $customer->id?'selected':''}}
                                ...
                                <div class="col-2 form-group">
                                    ...
                                    <input required class="form-control form-control-sm datepicker" type="text"
                                        ...
                                        value="{{$quote->start_date->format('d/m/Y')}}">
                                </div>
                                <div class="col-2 form-group">
                                    <label>Expiry: </label>
                                    <input class="form-control form-control-sm datepicker" type="text" name="end_date"
                                        data-date-format="dd/mm/yyyy" value="{{$quote->end_date->format('d/m/Y')}}">
                                </div>
                                <div class="col-2 form-group">
                                ...
                                <div class="col-2 form-group">
                                    ...
                                    <input class="form-control form-control-sm ourRefInput" type="text" name=""
                                        placeholder="{{$quote->customer->customer_ref}}">
                            ...
                            <div class="row">
                                <div class="col-sm-11 form-group">
                                    ...
                                    <textarea class="form-control" rows="2" placeholder="Quote terms and Conditions"
                                        ...
                                        name="quote_terms">{{$quote->quote_terms}}</textarea>
                                </div>
                                <div class="col-sm-1">
                                    <br><br>
...
function Quotes() {
    $.ajax({
        url: '{{route("quote.edit",[$quote->profession_id, $quote->customer_card_id, $quote->inv_no])}}',
        method:'get',
        success:res=>{
            if(res.status == 200){
                let jobData = '';
