                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="recur_end"
                                                    {{$invoice->untill_date?'checked':''}} value="radio1" id="radio1">
                                                <label class="form-check-label" for="radio1">
                                                    Untill date
                                                </label>
                                                <input type="text" class="form-control item_date" name="untill_date" readonly
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="recur_end"
                                                    {{$invoice->unlimited?'checked':''}} value="radio2" id="no_date">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            ...
                                            <input type="email" class="form-control" value="{{$invoice->mail_to}}"
                                                name="mail_to">
                                        </div>
                                    </div>
                                    <br>
