                                ...
                                <table border="0" cellpadding="5" cellspacing="0" width="100%">
                                    <tr>
                                        <td width="96%" style="font-size: 12px;">
                                            <div style="font-size:14px; font-weight:800;">Billing Address:</div> <br>
                                            <br>
                        ...
                        <tr>
                            ...
                            <td width="45%" border="0" style="border-left:1px solid black;">
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">GST
                                        </td>
                                        {{-- <td style="border-bottom:1px solid black;border-right:1px solid black;">
                                            {{number_format($invoices->sum('disc_amount'),2)}}</td> --}}
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;"
                                            class="text-right">{{number_format($invoices->sum('amount') -
                                            $invoices->sum('freight_charge') -$invoices->sum('price') ,2)}}</td>
                                    </tr>
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">Total
                                        </td>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;"
                                            class="text-right">{{number_format($invoices->sum('amount'),2)}}</td>
                                    </tr>
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;">Paid Amt
                                        </td>
                                        <td style="border-bottom:1px solid black;border-right:1px solid black;"
                                            class="text-right">{{number_format($invoices->sum('payment_amount'),2)}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="border-right:1px solid black;">Due on this Invoice</td>
                                        <td style="border-right:1px solid black;" class="text-right">
                                            {{number_format($invoices->sum('amount') -
