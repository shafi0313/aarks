            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{route('recurring.update',$invoice->inv_no)}}" method="POST" autocomplete="off" id="recurringUpdate">
                            @csrf @method('put')
                            @if ($errors->any())
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 form-group">
                                    ...
                                    <input required class="form-control form-control-sm datepicker" type="text"
                                        ...
                                        value="{{$invoice->tran_date->format('d/m/Y')}}">
                                </div>
                                <div class="col-2 form-group">
                                    <label>Invoice No: </label>
                                    <input class="form-control form-control-sm" readonly type="text" name="inv_no" value="{{$invoice->inv_no}}">
                                </div>
                                <div class="col-2 form-group">
                                    <label>Your Reference: </label>
                                    <input class="form-control form-control-sm" type="text" name="your_ref" value="{{$invoice->your_ref}}">
                                </div>
                                <div class="col-2 form-group">
                                    ...
                                    <input class="form-control form-control-sm ourRefInput" type="text" name="our_ref"
                                        placeholder="{{$invoice->customer->customer_ref}}">
                            ...
                            <div class="row">
                                <div class="col-sm-11 form-group">
                                    ...
                                    <textarea class="form-control" rows="2" placeholder="Quote terms and Conditions"
                                        ...
                                        name="quote_terms">{{$invoice->quote_terms}}</textarea>
                                </div>
                                <div class="col-sm-1">
                                    <br><br>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="recurring" id="recurring" class="form-control">
                                                    <option {{$invoice->recurring==1?'selected':''}} value="1">Dalily
                                                    </option>
                                                    <option {{$invoice->recurring==2?'selected':''}} value="2">Weekly
                                                    </option>
                                                    <option {{$invoice->recurring==3?'selected':''}} value="3">
                                                        Forthnightly</option>
                                                    <option {{$invoice->recurring==4?'selected':''}} value="4">Every
                                                        four weeks</option>
                                                    <option {{$invoice->recurring==5?'selected':''}} value="5">Every
                                                        monthly</option>
                                                    <option {{$invoice->recurring==6?'selected':''}} value="6">Every
                                                        three month</option>
                                                    <option {{$invoice->recurring==7?'selected':''}} value="7">Every
                                                        yearly</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="recur_end" {{$invoice->untill_date?'checked':''}}
                                                    value="radio1" id="radio1">
                                                <label class="form-check-label" for="radio1">
                                                    Untill date
                                                </label>
                                                <input type="text" class="form-control item_date" name="untill_date"
                                                    value="{{$invoice->untill_date != null?$invoice->untill_date->format('d/m/Y'):''}}" id="untill_date"
                                                    data-date-format="dd/mm/yyyy" {{$invoice->untill_date?'':'disabled'}}>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="recur_end" {{$invoice->unlimited?'checked':''}}
                                                    value="radio2" id="no_date">
                                            ...
                                            <div class="form-check">
                                                <div class="row">
                                                    <input class="form-check-input" type="radio" name="recur_end"
                                                        {{$invoice->recur_tran != 0?'checked':''}} value="radio3" id="radio3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            ...
                                            <input type="email" class="form-control" value="{{$invoice->mail_to}}" name="mail_to">
                                        </div>
                                    </div>
                                    <br>
                                </div>
