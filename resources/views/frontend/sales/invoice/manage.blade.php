                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-primary">
                                        <a
                                            href="{{route('inv.report',['service',$invoice->inv_no,$client->id,$invoice->customer_card_id])}}">{{invoice($invoice->inv_no,
                                            8, 'INV')}}</a>
                                    </td>
                                    <td class="text-info text-right">$ {{number_format($inv_grp->first()->totalAmt,2)}}
                                    </td>
                                    <td class="text-danger text-right">$
                                        {{number_format($inv_grp->first()->totalAmt -
                                        $invoice->payments->sum('payment_amount'),2)}}
                                    </td>
