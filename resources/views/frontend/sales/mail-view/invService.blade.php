                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            ...
                            $one_of = \App\Models\CustomerTempInfo::whereCustomerCardId($customer->id)->whereInvNo($inv->inv_no)->first();
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <div class="d-flex">
                                        <div class="">
                                            <img src="{{asset('admin/assets/images/inv.png')}}" alt="INV" class="img-responsive img-fluid" width="52">
                                        </div>
                                        <div class="">
                                    ...
                                    <nav>
                                        <ul class="nav">
                                            <li class="nav-item">
                                                <a target="_blank" href="{{route('inv.report.print', ['service',$inv_no, $client->id, $one_of->id])}}" class="nav-link">
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{number_format($invoices->sum('amount') - $invoices->sum('payment_amount'),2)}}</td>
                                        </tr>
                                        <br>
                                        <tr>
                                            <td>
