                            ...
                            <table id="example" class="table table-striped table-bordered table-hover display table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('quote_item.convertView',$quote->first()->inv_no)}}" class="btn btn-sm btn-info">VIEW</a>
                                            <a href="{{route('quote_item.convertStore',$quote->first()->inv_no)}}" class="btn btn-sm btn-primary">Convert</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
