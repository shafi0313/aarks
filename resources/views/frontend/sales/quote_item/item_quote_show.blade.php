                        ...
                        <div class="card-body row" id="printarea">
                            ...
                            <div class="col-md-12">
                                <b>Billing Address:</b><u class="text-center"
                                    style="font-size: 25px; font-weight: bold; margin-left:175px">Quotation</u>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex pull-right">
                                    ...
                                    <div class="mx-2">
                                        <a href="{{ route('quote.print', ['item', $inv_no, $client->id, $customer->id]) }}"
                                            target="_blank" class="btn btn-outline-info text-dark btn-lg"> <i
