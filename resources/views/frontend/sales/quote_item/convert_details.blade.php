                    ...
                    <div class="card-body">
                        <div id="resultshow" style="padding-top:10px;">
                            <div align="center">
                                ...
                                <strong>Order Convert To INV</strong>
                                <style>
                                ...
                                <table class="table table-bordered table-sm">
                                    <tbody>
                                        <tr>
                                            <th style="text-align:center" width="15%">Order Name</th>
                                ...
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tfoot>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a href="{{route('quote_item.edit',$dedotrs->first()->inv_no)}}"
                                                    class="btn btn-warning btn-sm">
                                                    <i class="far fa-edit"></i> Edit
                                                </a>
                                                <a href="{{route('quote_item.convertStore',$dedotrs->first()->inv_no)}}"
