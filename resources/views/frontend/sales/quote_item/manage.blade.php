                                ...
                                <form action="{{route('edit.print.filter')}}" method="get" autocomplete="off">
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-3 form-group">
                                            <input class="form-control datepicker" value="{{request()->start_date}}" data-date-format="dd/mm/yyyy"
                                                name="start_date" placeholder="From Date">
                                        </div>
                                        <div class="col-3 form-group">
                                            <input class="form-control datepicker" value="{{request()->end_date}}" data-date-format="dd/mm/yyyy"
