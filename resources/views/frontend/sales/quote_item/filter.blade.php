                                ...
                                <form action="{{route('edit.print.filter')}}" method="get" autocomplete="off">
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-3 form-group">
                                            <input class="form-control datepicker" data-date-format="dd/mm/yyyy" value="{{request()->start_date}}"
                                                name="start_date" placeholder="From Date">
                                        </div>
                                        <div class="col-3 form-group">
                                            <input class="form-control datepicker" data-date-format="dd/mm/yyyy" value="{{request()->end_date}}"
                        ...
                        <table id="example" class="table table-striped table-bordered table-hover display table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action">
                                            <a  title="Quote Edit" href="{{route('quote_item.edit',$quote->first()->inv_no)}}"
