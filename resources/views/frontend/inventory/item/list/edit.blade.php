                ...
                <form action="{{ route('inv_item.update', $inv_item->id) }}" method="post" autocomplete="off">
                    ...
                    <div>
                        ...
                        <samp style="padding-left:50px; font-size:20px; color:#9933FF;">
                            ...
                            <label class="radio-inline">
                                <input checked type="radio" name="profession_id" id="profession_id"
                                    value="{{ $inv_item->profession->id }}">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category" id="categoryName">
                                    <option value="{{ $inv_item->category }}" selected>{{ $inv_item->category }}
                                    </option>
                    ...
                    <div class="col-md-12" style="padding-top:20px;">
                        <div class="row">
                            ...
                            <div class="col-md-3" style="padding-top:25px;">
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input {{ $inv_item->status == '1' ? 'checked' : '' }} type="radio"
                                            name="status" value="1"> Active Item
                                    </label>&nbsp;&nbsp;
                                    <label class="radio-inline">
                                        <input {{ $inv_item->status == '0' ? 'checked' : '' }}type="radio"
                                            name="status" value="0"> Inactive Item
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row text-center">
                        <div class="col-md-12" style="padding-top:22px;">
                            <button type="submit" class="btn btn-danger btn200 barcodeCheck">Update</button>
                        </div>
                    </div>
                </form>
            </div>
