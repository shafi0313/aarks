                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-heading d-flex">
                            ...
                            <button type="button"  class="btn btn-secondary ml-auto" data-toggle="modal" data-target="#add-category">
                                Add Category
                            </button>
                        </div>
                        <table id="DataTable" class="table table-bordered table-hover table-sm display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <i  title="Invoice Category Add" class="btn btn-sm btn-success fa fa-plus addSub" data-toggle="modal" data-target="#add-sub" data-id="{{$inv->id}}"></i>
                                        <i  title="Invoice Category Edit" class="btn btn-sm btn-info fa fa-edit edit" data-toggle="modal" data-target="#edit" data-url="{{route('inv_category.update', $inv->id)}}" data-name="{{$inv->name}}"></i>
                                ...
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td style="color: rgb(245, 111, 134)"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$sinv->name}}</td>
                                    <td align="center">
                                        <i class="btn btn-sm btn-info fa fa-edit edit" data-toggle="modal" data-target="#edit"
                                            data-url="{{route('inv_category.update', $sinv->id)}}" data-name="{{$sinv->name}}"></i>
                                        <a href="{{route('inv_category.show', $sinv->id)}}" onclick="return confirm('are you sure?')"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sub-name" name="name" placeholder="Sub Category Name" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
