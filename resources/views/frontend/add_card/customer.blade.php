                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="nav-profile" role="tabpanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-4 text-right">Status: <span class="t_red">*</span>
                                                    </div>
                                                    <div class="col-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="col-4 text-right">Address:<span
                                                                class="t_red">*</span> </label>
                                                        <input required class="col-8 form-control form-control-sm"
                                                            type="text" name="b_address" id="b_address">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="col-4 text-right">City: <span
                                                                class="t_red">*</span></label>
                                                        <input required class="col-8 form-control form-control-sm"
                                                            type="text" name="b_city" id="b_city">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="col-4 text-right">Postcode: <span
                                                                class="t_red">*</span></label>
                                                        <input required class="col-8 form-control form-control-sm"
                                                            type="text" name="b_postcode" id="b_postcode">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="col-4 text-right">Country: <span
                                                                class="t_red">*</span></label>
                                                        <input required class="col-8 form-control form-control-sm"
                                                            type="text" name="b_country" id="b_country">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="col-4 text-right">Invoice Layout: <span
                                                                class="t_red">*</span></label>
                                                        <select required class="col-8 form-control form-control-sm"
                                                            name="inv_layout">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <select class="col-8 form-control form-control-sm"
                                                            name="barcode_price">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <input class="col-8 form-control form-control-sm" type="number"
                                                            name="inv_rate" placeholder="$00.00">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <input class="col-8 form-control form-control-sm" type="number"
                                                            name="card_limit" placeholder="$00.00">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <select class="col-8 form-control form-control-sm"
                                                                    ...
                                                                    <option value="Happy Holidays">Happy Holidays!.
                                                                    </option>
                                                                    ...
                                                                    <option value="We appreciate your business">We
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <input class="col-6 form-control form-control-sm"
                                                                    name="early_discount" placeholder="%">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <input class="col-6 form-control form-control-sm"
                                                                    name="overall_discount" placeholder="%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <select
                                                                    onchange="getDays($(this).find(':selected').data('id'))"
                                                                    ...
                                                                    <option data-id="1"
                                                                        value="No of days from the Invoice Date">No of days
                                                                        from the Invoice Date</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <input
                                                                    class="col-6 form-control form-control-sm datepicker"
                                                                    type="text" data-date-format="dd/mm/yyyy"
                                                                    data-end-date="0d" name="by_date">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <input
                                                                    class="col-6 form-control form-control-sm datepicker"
                                                                    type="text" data-date-format="dd/mm/yyyy"
                                                                    data-end-date="0d" name="after_date">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <select class="col-8 form-control form-control-sm"
                                                                    name="payment_method" onchange="getBsb(this.value)">
                                    ...
                                    <div class="tab-pane fade show" id="nav-transaction" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                <label>Opening Balance <span style="font-size: 12px">(wright 0 if there is
                                                        no amount)</span><span class="t_red">*</span></label>
                                                <input class="form-control form-control-sm" type="number" step="any"
                                                    id="opening_blnc" name="opening_blnc" required>
                                            </div>
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input class="form-control form-control-sm datepicker"
                                                    ...
                                                    name="opening_blnc_date"id="opening_blnc_date" disabled>
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label>Credit Account <span class="t_red">*</span></label>
                                                <select class="form-control form-control-sm" name="credit_account"
                                                    id="credit_account" disabled>
                                                    @foreach ($creditCodes as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id == 1351 ? 'selected' : '' }}>{{ $item->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="m-auto">
                                                <div class="alert alert-danger"
                                                    style="color:black; padding: 2px; margin: 5px">Caution!! Customer
                                                    opening balance date must be previous year closing date. i.e
                                                    30/06/prevous financial year.</div>
                                            </div>
