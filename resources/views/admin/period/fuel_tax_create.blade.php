...
<div id="myModal" class="modal fade" tabindex="-1" data-backdrop="static">
    <form id="fueltaxform" action="{{route('fuel.store')}} " method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="rate" id="fuel_rate" value="@if($fuel) {{$fuel->rate??0}} @endif">
        <div class="modal-dialog" style="width:600px; z-index:1000000000;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <i class="fa-solid fa-triangle-exclamation text-danger" style="font-size: 25px" title="Before FTC entering please check the FTC rate"></i><h4 class="modal-title" align="center">
                        <span class="label label-xlg label-primary arrowed-right">
                            Current Rate: @if($fuel) {{$fuel->rate??0}}@endif
                        </span>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" align="center">
                        ...
                        <span class="label label-xlg label-pink arrowed-in arrowed-in-right">Add PAYG Installment</span>
                        <span class="label label-xlg label-primary arrowed">{{
                        ...
                        <div class="modal-body">
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control payg_percenttige" name="payg_percenttige"
                                        id="payg_percenttige" required="required" value=""
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control payg_amount" id="payg_amount"
                                        name="payg_amount" placeholder="Enter Amount" required="required" value="">
                                </div>
                            </div>
                        </div>
                    </div>
