        ...
        <tbody>
            <tr>
                <form id="amount_addForm" action="{{route('dataStore.store')}}" method="post"
                    ...
                    <td style="width:10%">
                        <input type="number" step="any" id="amount" class="form-control" value="{{old('amount')}}"
                            name="amount" style="width:100%" placeholder=" Amount $" required TabIndex='2'>
                        <div id="msg"></div>
                        @error('amount')
                    ...
                    <td style="width:8%" id="gstfild">
                        <input class="gst form-control" step="any" type="number" id="gstamt" value="{{old('gstamt')}}"
                            name="gstamt" style="width:100%" placeholder=" GST $" TabIndex='3'>
                    </td>
                    ...
                    <td style="width:8%" id="gstfild">
                        <input class="gst form-control" step="any" type="number" id="gstamt" name="gstamt"
                            style="width:100%" value="{{old('gstamt')}}" placeholder=" GST $" TabIndex='3' disabled>
                    </td>
                    <td style="width:9%" id="totalinvfild">
                        {{-- <div id="msginv" class=" text-danger"></div> --}}
                        <input class="totalinv form-control" step="any" type="text" id="totalinv" name="totalinv"
                            style="width:100%" placeholder=" T/Inv $" value="{{old('totalinv')}}" TabIndex='4' disabled>
                    </td>
                    @endif
                    <td style="width:11%" id="balancefiled">
                        <input class="balance form-control" step="any" type="text" id="balance" name="balance"
                            style="width:100%" value="{{old('balance')}}" placeholder=" Balance" disabled>
                    </td>
                    <td style="width:10%">
                    ...
                    <td style="width:35%">
                        <input type="text" required id="note" name="note" style="width:100%" class="form-control"
                            placeholder=" Note" TabIndex='6' value="{{old('note')}}">
                        {{-- @error('note')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror --}}
                    </td>
