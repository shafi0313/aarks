                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                @foreach ($ledgers as $ledger)
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="{{ route('general_ledger.data_store.transaction', [$ledger->transaction_id, $ledger->chart_id, $ledger->source]) }}"
                                                style="color: green;text-decoration: underline">{{ $ledger->transaction_id }}
                                            </a>
                                        </td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        {{ number_format(abs($sum['debit'] + abs($ldebit) + abs($Bdebit)), 2) }}</td>
                                    <td class="text-right">
                                        {{ number_format(abs($sum['credit'] + abs($lcredit) + abs($Bcredit)), 2) }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div><!-- /.row -->
