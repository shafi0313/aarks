                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <input disabled type="text" class="form-control datepicker "
                                                value="{{ $journal->date->format('d/m/Y') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 row">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" disabled class="form-control"
                                                value="{{ invoice($journal->journal_number) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 row">
                                    <div class="form-group form-group-sm">
                                        <label for="journal_reference" class="col-sm-5 control-label">Journal
                                            Reference</label>
                                        <div class="col-sm-7">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table class="tbl">
                                        ...
                                        <form action="{{ route('journal_list_update', $journal->id) }}" method="POST">
                                            ...
                                            <input type="hidden" name="journal_number"
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="code_id[]"
                                                            value="{{ $code->id }}" id="code_id{{ $i }}">
                                                        <input type="hidden" name="type[]" value="{{ $code->type }}"
                                                            id="type{{ $i }}">
                                                        <input type="hidden" name="gst_code[]"
                                                            value="{{ $jnl->gst_code }}" class="gst_code">
                                                        <input type="hidden" name="id[]"
                                                            value="{{ $jnl->id }}">
                                                    </td>
                                                    <td>
                                                        <input value="{{ $jnl->narration }}" class="form-control"
                                                            id="narration{{ $i }}" type="text" required
                                                            name="narration[]">
                                                    </td>
                                                    <td>
                                                        <input type="text" disabled value="{{ $jnl->gst_code }}"
                                                            class="form-control">
                                                    </td>
                                                    <td>
                                                        <input value="{{ number_format(abs($Idebit), 2, '.', '') }}"
                                                            name="debit[]" class="form-control idebit" data-tt="debit"
                                                            type="number" min="0" step=".01">
                                                    </td>
                                                    <td>
                                                        <input value="{{ number_format(abs($Icredit), 2, '.', '') }}"
                                                            name="credit[]" class="form-control icredit" data-tt="credit"
                                                            type="number" min="0" step=".01">
                                                    </td>
                                                    <td>
                                                        <input value="{{ number_format(abs($jnl->net_amount), 2, '.', '') }}"
                                                            name="net_amount[]" class="form-control iexTax"
                                                            type="text" readonly>
                                                    </td>
                                                    <td>
                                                        <input value="{{ number_format(abs($jnl->gst), 2, '.', '') }}"
                                                            name="gst[]" class="form-control itax" type="text"
                                                            readonly>
                                                    </td>
                                                    <td class="center">
                                                        @if ($jnl->is_edited == 1)
                                                            <a title="journal_entry delete" data-id="{{ $jnl->id }}"
                                                                onclick="return confirm('are you sure?')" class="red"
                                                                id="delete"
                                                                href="{{ route('journal_entry.delete', $jnl->id) }}"><i
                                                                    class="ace-icon fa fa-trash-o bigger-130"></i></a>
                                                        @else
                                                        <a title="Delete" data-id="{{ $jnl->id }}"
                                                            onclick="return confirm('are you sure?')" class="red"                                                            
                                                            href="{{ route('journal_list_singleDelete', $jnl->id) }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input value="{{ number_format(abs($totalD), 2) }}"
                                                        class="form-control totalD" type="text" disabled>
                                                </td>
                                                <td>
                                                    <input value="{{ number_format(abs($totalC), 2) }}"
                                                        class="form-control totalC" type="text" disabled>
                                                </td>
                                                <td>
                                                    <input value="{{ number_format(abs($totalB), 2) }}"
                                                        class="form-control totalB" type="text" disabled>
                                                </td>
                                                <td>
                                                    <input value="{{ number_format(abs($totalG), 2) }}"
                                                        class="form-control totalG" type="text" disabled>
                                                </td>
                                                <td class="center">
                                                    <input type="submit" value="Journal Update"
                                                        class="btn btn-danger form-control d-hide" style="float: right; "
                                                        id="journal_post" {{ $totalD == $totalC ? '' : 'disabled' }}>
                                                </td>
                                            </tr>
                                        </form>
                                    </table>
