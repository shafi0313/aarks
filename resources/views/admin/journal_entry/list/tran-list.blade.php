                                ...
                                <table id="dataTable" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>
                                                <a href="{{route('journal_list_trans_show',[$client->id,$profession->id,$journal->tran_id])}}">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('journal_list_delete', $journal->id)}}" method="post" style="display: inline-block;">
                                                    @csrf @method('delete')
                                                    <button onclick="return confirm('You will lost all data!')" title="Journal List Delete" type="submit" class="btn btn-danger btn-sm"><i class="fa fa-trash "></i></button>
                                                </form>
                                                @endcan
                                            </td>
                                        </tr>
