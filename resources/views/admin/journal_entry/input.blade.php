                            ...
                            <div class="row" style="padding-bottom: 10px;">
                                <div class="col-md-4 row">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control datepicker " @error('journal_date') style="border: 1px solid red;" @enderror id="journal_date" name="journal_date" placeholder="dd/mm/yyyy" autocomplete="off">
                                ...
                                <div class="col-md-4 row">
                                    <div class="form-group form-group-sm">
                                        <label for="journal_number" class="col-sm-5 control-label">Journal Number</label>
                                        <div class="col-sm-7">
                                        <input type="text" readonly class="form-control" id="journal_number" name="journal_number" value="{{invoice($journal_number)}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 row">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="journal_reference" @error('journal_reference') style="border: 1px solid red;" @enderror name="journal_reference" placeholder="journal Reference" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <form action="{{route('journal_entry.post')}}" method="POST">
                                        ...
                                        <input type="hidden" name="journal_number" id="post_journal_number" value="{{$journal_number}}">
                                        <input type="hidden" name="journal_reference" id="post_journal_reference">
                                        <input type="hidden" name="client_id" value="{{$client->id}}">
                                        <input type="hidden" name="profession_id" value="{{$profession->id}}">
                                        <input type="submit" value="Journal Post" class="btn btn-primary d-hide" style="float: right; " id="journal_post" disabled>
                                    </form>
                            </div>

                            <p class="text-danger" style="font-size:15px">***To enter historical  records, please enter last year' full trial balance(including Income and Expenses exclude retained earning)***</p>


<script>
    readData();
    // $("#journal_date").keyup((e)=>{
    //     let date = $("#journal_date").val();
    //         let i = 1;
    //         let j = '00000';
    //     if(date.length == 10){
    //         $.ajax({
    //             url:"{{route('journal_number')}}",
    //             method: 'get',
    //             data:{
    //                 date:date,
    //                 client_id:"{{$client->id}}",
    ...
    //                     $('#journal_number').val(j+(res.count));
    //                 }
    //             }
    //         });
    //     }else{
    //         $('#journal_number').val(j+{{$journal_number}});
    //     }
    // });
