                    ...
                    <div class="login-container">
                        <div class="center">
                            <h1>
                                ...
                                <span class="red">AARKS</span>
                                <span class="white" id="id-text2">Application</span>
                            </h1>
                            <h4 class="blue" id="id-company-text">&copy; Advanced Accounting and Record Keeping
                                Software</h4>
                        </div>
                            ...
                            <div id="login-box" class="login-box visible widget-box no-border">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <h4
                                            class="header @if ($errors->has('unauthenticated')) red @else blue @endif lighter bigger">
                                        ...
                                        @if ($errors->has('unauthenticated'))
                                            <span class="text-danger">{{ $errors->first('unauthenticated') }}</span>
                                        @endif
...
<![endif]-->
    <script type="text/javascript">
        if ('ontouchstart' in document.documentElement) document.write(
            "<script src='{{ asset('admin/assets/js/jquery.mobile.custom.min.js') }}'>" + "<" + "/script>");
    </script>
