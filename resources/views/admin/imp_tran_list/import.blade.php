    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('bs_tran_list.report',[$client->id,$profession->id]) }}">{{$profession->name}}</a>
                </li>
            </ul><!-- /.breadcrumb -->
        </div>
                            ...
                            @endif
                                <table class="tbl">
                                    ...
                                    <tr>
                                        ...
                                        @if(!request()->only_view)
                                        <td class="center">
                                            <a title="BS Tran List Delete" class="btn btn-sm btn-danger text-light fa fa-trash"
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <button onclick="return confirm('Are you sure?')" type="submit"
                                                class="btn btn-info mt-4 form-control" style="float: right; "> Update</button>
                                        </td>
                                    </tr>
                                        @endif
                                </table>
