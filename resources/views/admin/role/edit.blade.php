                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action="{{route('role.update',$role->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="name" value="{{$role->name}}" placeholder="Enter User Name"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox" value="{{$permissions['admin.user.index']}}"
                                                        name="permission[]" {{in_array('admin.user.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    List <br>
                                                    <input type="checkbox" value="{{$permissions['admin.user.create']}}"
                                                        name="permission[]" {{in_array('admin.user.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Add <br>
                                                    <input type="checkbox" value="{{$permissions['admin.user.edit']}}"
                                                        name="permission[]" {{in_array('admin.user.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.user.deactivate']}}"
                                                        name="permission[]" {{in_array('admin.user.deactivate',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Deactivate
                                                    <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.user.reactivate']}}"
                                                        name="permission[]" {{in_array('admin.user.reactivate',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Reactivate
                                                    <br>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox" value="{{$permissions['admin.role.index']}}"
                                                        name="permission[]" {{in_array('admin.role.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    List <br>
                                                    <input type="checkbox" value="{{$permissions['admin.role.create']}}"
                                                        name="permission[]" {{in_array('admin.role.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox" value="{{$permissions['admin.role.edit']}}"
                                                        name="permission[]" {{in_array('admin.role.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.profession.index',
                                                        $role_permissions) ? 'checked' : '' }}>

                                                    List <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.profession.create']}}"
                                                        name="permission[]" {{in_array('admin.profession.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create
                                                    <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.profession.edit']}}"
                                                        name="permission[]" {{in_array('admin.profession.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit
                                                    <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.profession.delete']}}"
                                                        name="permission[]" {{in_array('admin.profession.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete
                                                    <br>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.master-chart.index',
                                                        $role_permissions) ? 'checked' : '' }}>

                                                    Chart List <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.master-chart.create']}}"
                                                        name="permission[]" {{in_array('admin.master-chart.create',
                                                        $role_permissions) ? 'checked' : '' }}>

                                                    Chart Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.master-chart.edit']}}"
                                                        name="permission[]" {{in_array('admin.master-chart.edit',
                                                        $role_permissions) ? 'checked' : '' }}>

                                                    Chart Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.master-chart.delete']}}"
                                                        name="permission[]" {{in_array('admin.master-chart.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    ...
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]"
                                                        {{in_array('admin.master-chart.sub-category.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Sub Group
                                                    Create
                                                    <br>
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]"
                                                        {{in_array('admin.master-chart.additional-category.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Sub
                                                    Sub
                                                    Group Create <br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.account-code.index',
                                                        $role_permissions) ? 'checked' : '' }}>

                                                    Code List <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.account-code.create']}}"
                                                        name="permission[]" {{in_array('admin.account-code.create',
                                                        $role_permissions) ? 'checked' : '' }}>

                                                    Code Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.account-code.edit']}}"
                                                        name="permission[]" {{in_array('admin.account-code.edit',
                                                        $role_permissions) ? 'checked' : '' }}>

                                                    Code Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.account-code.delete']}}"
                                                        name="permission[]" {{in_array('admin.account-code.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    ...
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]"
                                                        {{in_array('admin.account-code.sub-category.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Sub Group Create
                                                    <br>
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]"
                                                        {{in_array('admin.account-code.additional-category.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Sub Sub
                                                    Group Create <br>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.fuel_tax_cr.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.fuel_tax_cr.create']}}"
                                                        name="permission[]" {{in_array('admin.fuel_tax_cr.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.fuel_tax_cr.edit']}}"
                                                        name="permission[]" {{in_array('admin.fuel_tax_cr.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.fuel_tax_cr.delete']}}"
                                                        name="permission[]" {{in_array('admin.fuel_tax_cr.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.service.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    List
                                                    <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.service.create']}}"
                                                        name="permission[]" {{in_array('admin.service.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create
                                                    <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.service.edit']}}"
                                                        name="permission[]" {{in_array('admin.service.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit
                                                    <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.service.delete']}}"
                                                        name="permission[]" {{in_array('admin.service.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete
                                                    <br>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.verify_account.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Verify & Fixed Trans <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.period_lock.index']}}"
                                                        name="permission[]" {{in_array('admin.period_lock.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Period Lock <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.client.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    List <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.client.create']}}"
                                                        name="permission[]" {{in_array('admin.client.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Add <br>
                                                    <input type="checkbox" value="{{$permissions['admin.client.edit']}}"
                                                        name="permission[]" {{in_array('admin.client.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.client.delete']}}"
                                                        name="permission[]" {{in_array('admin.client.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete
                                                    <br>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.client_payment.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.client_payment.create']}}"
                                                        name="permission[]" {{in_array('admin.client_payment.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.client_payment.edit']}}"
                                                        name="permission[]" {{in_array('admin.client_payment.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.client_payment.delete']}}"
                                                        name="permission[]" {{in_array('admin.client_payment.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.period.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.period.create']}}"
                                                        name="permission[]" {{in_array('admin.period.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox" value="{{$permissions['admin.period.edit']}}"
                                                        name="permission[]" {{in_array('admin.period.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.period.delete']}}"
                                                        name="permission[]" {{in_array('admin.period.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox" value="{{$permissions['admin.adt.index']}}"
                                                        name="permission[]" {{in_array('admin.adt.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox" value="{{$permissions['admin.adt.create']}}"
                                                        name="permission[]" {{in_array('admin.adt.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox" value="{{$permissions['admin.adt.edit']}}"
                                                        name="permission[]" {{in_array('admin.adt.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox" value="{{$permissions['admin.adt.delete']}}"
                                                        name="permission[]" {{in_array('admin.adt.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.bs_import.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bs_import.create']}}"
                                                        name="permission[]" {{in_array('admin.bs_import.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bs_import.edit']}}"
                                                        name="permission[]" {{in_array('admin.bs_import.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.bs_input.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bs_input.create']}}"
                                                        name="permission[]" {{in_array('admin.bs_input.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bs_input.edit']}}"
                                                        name="permission[]" {{in_array('admin.bs_input.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bs_input.post']}}"
                                                        name="permission[]" {{in_array('admin.bs_input.post',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Post <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.depreciation.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.depreciation.create']}}"
                                                        name="permission[]" {{in_array('admin.depreciation.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.depreciation.edit']}}"
                                                        name="permission[]" {{in_array('admin.depreciation.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.depreciation.delete']}}"
                                                        name="permission[]" {{in_array('admin.depreciation.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.manage_invest.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.manage_invest.create']}}"
                                                        name="permission[]" {{in_array('admin.manage_invest.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.manage_invest.edit']}}"
                                                        name="permission[]" {{in_array('admin.manage_invest.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.manage_invest.delete']}}"
                                                        name="permission[]" {{in_array('admin.manage_invest.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.close_year.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.close_year.create']}}"
                                                        name="permission[]" {{in_array('admin.close_year.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.close_year.edit']}}"
                                                        name="permission[]" {{in_array('admin.close_year.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.close_year.delete']}}"
                                                        name="permission[]" {{in_array('admin.close_year.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.cash_basis.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Cash Basis <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.periodic_cash.index']}}"
                                                        name="permission[]" {{in_array('admin.periodic_cash.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Periodic Cash <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.accrued_basis.index']}}"
                                                        name="permission[]" {{in_array('admin.accrued_basis.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Accrued Basis <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.periodic_accrued.index']}}"
                                                        name="permission[]" {{in_array('admin.periodic_accrued.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Periodic Accrued <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.trial_balance.index']}}"
                                                        name="permission[]" {{in_array('admin.trial_balance.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Trial Balance <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.cons_trial_balance.index']}}"
                                                        name="permission[]" {{in_array('admin.cons_trial_balance.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.general_ledger.index',
                                                        $role_permissions) ? 'checked' : '' }}> General Ledger<br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.profit_loss_excl.index']}}"
                                                        name="permission[]" {{in_array('admin.profit_loss_excl.index',
                                                        $role_permissions) ? 'checked' : '' }}> Profit & Loss excl <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.profit_loss_incl.index']}}"
                                                        name="permission[]" {{in_array('admin.profit_loss_incl.index',
                                                        $role_permissions) ? 'checked' : '' }}> Profit & Loss incl <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.balance_sheet.index']}}"
                                                        name="permission[]" {{in_array('admin.balance_sheet.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Balance Sheet<br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.comperative_bs.index',
                                                        $role_permissions) ? 'checked' : '' }}> Comperative BS<br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.complete_financial_report.index']}}"
                                                        name="permission[]"
                                                        {{in_array('admin.complete_financial_report.index',
                                                        $role_permissions) ? 'checked' : '' }}> Complete Financial
                                                    report <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.comperative_financial_report.index']}}"
                                                        name="permission[]"
                                                        {{in_array('admin.comperative_financial_report.index',
                                                        $role_permissions) ? 'checked' : '' }}> Comperative financial
                                                    report<br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.advanced_report.index']}}"
                                                        name="permission[]" {{in_array('admin.advanced_report.index',
                                                        $role_permissions) ? 'checked' : '' }}> advanced report<br>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]"
                                                        {{in_array('admin.depreciation_report.index', $role_permissions)
                                                        ? 'checked' : '' }}> Depreciation report<br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.consolidated_report.index']}}"
                                                        name="permission[]"
                                                        {{in_array('admin.consolidated_report.index', $role_permissions)
                                                        ? 'checked' : '' }}> Consolidated report <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.financial_analysis.index']}}"
                                                        name="permission[]" {{in_array('admin.financial_analysis.index',
                                                        $role_permissions) ? 'checked' : '' }}> Financial Analysis<br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.ratio_report.index']}}"
                                                        name="permission[]" {{in_array('admin.ratio_report.index',
                                                        $role_permissions) ? 'checked' : '' }}> Ratio Report<br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.investment_report.index']}}"
                                                        name="permission[]" {{in_array('admin.investment_report.index',
                                                        $role_permissions) ? 'checked' : '' }}> Investment Report<br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.journal_list.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.journal_list.create']}}"
                                                        name="permission[]" {{in_array('admin.journal_list.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.journal_list.edit']}}"
                                                        name="permission[]" {{in_array('admin.journal_list.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.journal_list.delete']}}"
                                                        name="permission[]" {{in_array('admin.journal_list.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.bs_tranlist.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bs_tranlist.create']}}"
                                                        name="permission[]" {{in_array('admin.bs_tranlist.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bs_tranlist.edit']}}"
                                                        name="permission[]" {{in_array('admin.bs_tranlist.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bs_tranlist.delete']}}"
                                                        name="permission[]" {{in_array('admin.bs_tranlist.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.bank_recon.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bank_recon.create']}}"
                                                        name="permission[]" {{in_array('admin.bank_recon.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bank_recon.edit']}}"
                                                        name="permission[]" {{in_array('admin.bank_recon.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.bank_recon.delete']}}"
                                                        name="permission[]" {{in_array('admin.bank_recon.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.payment_sync.index',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Index <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.payment_sync.create']}}"
                                                        name="permission[]" {{in_array('admin.payment_sync.create',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Create <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.payment_sync.edit']}}"
                                                        name="permission[]" {{in_array('admin.payment_sync.edit',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Edit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.payment_sync.delete']}}"
                                                        name="permission[]" {{in_array('admin.payment_sync.delete',
                                                        $role_permissions) ? 'checked' : '' }}>
                                                    Delete <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="checkbox"
                                                        ...
                                                        name="permission[]" {{in_array('admin.database_dump.index',
                                                        $role_permissions) ? 'checked' : '' }}> Database Download<br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.logging_audit.index']}}"
                                                        name="permission[]" {{in_array('admin.logging_audit.index',
                                                        $role_permissions) ? 'checked' : '' }}> Logging Audit <br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.agent_audit.index']}}"
                                                        name="permission[]" {{in_array('admin.agent_audit.index',
                                                        $role_permissions) ? 'checked' : '' }}> Agent Audit<br>
                                                    <input type="checkbox"
                                                        value="{{$permissions['admin.visitor_info.index']}}"
                                                        name="permission[]" {{in_array('admin.visitor_info.index',
                                                        $role_permissions) ? 'checked' : '' }}> Visitor Informations<br>
                                                </div>
                                            </div>
