...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content" style="margin-top: 50px;">
            <form action="{{route('business-plan.update', $plan->id)}}" class="was-validated" method="post" autocomplete="off"
                autocapitalize="off">
                @csrf @method('put')
                ...
                <div align="center" class="row">
                    ...
                    <div class="col-lg-12">
                        @include('admin.add-edit-entry.business-plan.current-table')
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
