    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr class="{{substr($code->code, -6, 1) == 1 ? 'with_sales':'without_sales'}}">
                ...
                <td style="text-align: right" id="C-{{$l}}">
                    <input type="text" id="last_year_amount-{{$l}}" name="entries[{{$code->code}}][last_amount]"
                        class="last_year_with_sales last_year_amount text-right" value="{{$plan->last_amount}}">
                </td>
                <td id="D-{{$l}}">
                ...
                <td id="{{++$a}}-{{$l}}">
                    {{-- {{$a}}{{$l}} --}}
                    <input type="text" value="{{$new_percent}}" name="entries[{{$code->code}}][{{$name}}][new_percent]"
                ...
                <td style="text-align: right" id="{{++$a}}-{{$l}}" class="{{$type}}">
                    ...
                    <input type="hidden" value="{{$new_amount}}" name="entries[{{$code->code}}][{{$name}}][new_amount]"
            ...
            <tr class="text-right {{$type}} " style="font-size:16px">
                ...
                <td id="{{$type}}_C">
                    <input type="hidden" value="{{$last_year_total}}" name="last_year_total[]" class="last_year_total">
                ...
                <td id="{{$type}}_{{++$sum}}"></td>
                <td id="{{$type}}_{{++$sum}}">
                    <input type="hidden" value="{{$total_budget}}" name="total_budget[]" class="total_budget">
