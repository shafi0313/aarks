								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td>
                                                <a  title="Client Payment Approve" href="{{route('client_payment_pending_details',$paylist->id)}}">{{$paylist->status == 0 ? 'pending':'approved'}}</a>
                                            </td>
											<td>
												<div class="  action-buttons">
													<a  title="Client Payment Delete" onclick="return confirm('Are you sure?')" class="red" href="{{route('client_payment_delete',$paylist->id)}}">
