        ...
        <div class="page-content">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    @endif
                    <form action="{{route('client_payment_update',$payment->id)}}" method="post" enctype="multipart/form-data" role="form">
                        @csrf @method("PUT")
                        ...
                        <div class="form-group">
                            ...
                            <select name="subscription_id" id="subscription_id" class="form-control">
                                ...
                                <option value="{{$plan->id}}" {{$plan->id == $payment->subscription_id ? ' selected' :
                        ...
                        <div class="form-group">
                            Payment Date: {{$payment->started_at->diffForHumans()}}, {{$payment->started_at->format('D d
                            M, Y h:i:s A')}},
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            Package Name: <div class="badge badge-success p-2 rounded">{{$payment->subscription->name}}
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <table class="table table-striped table-bordered table-hovered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" class="form-control" name="invoice" id="invoice"
                                            value="{{$invoice}}">
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control" name="receipt" id="receipt"
                                            value="{{$receipt}}">
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="form-group">
                            ...
                            <table class="table table-striped table-bordered table-hovered">
                                ...
                                <tr>
                                    <td>
                                        <input type="number" step="any" class="form-control" name="purchase_quotation"
                                            id="purchase_quotation" value="{{$bill_quation}}">
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control" name="bill" id="bill"
                                            value="{{$bill}}">
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control" name="payment" id="payment"
                                            value="{{$bill_payment}}">
                                    </td>
                                </tr>
                            </table>
