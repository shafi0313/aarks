                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control" name="" id="bank_account"
                                        @error('bank_account') style="border: 1px solid red;" @enderror>
                                ...
                                <div class="col-md-3">
                                    <p style="color: green; font-size: 22px"><span id="bank_code_name"></span> Balance:
                                        <span id="bank_balance"></span></p>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table class="tbl">
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control is-invalid " name="" id="account_code"
                                                    required>
                                            ...
                                            <tbody id="result">
                                                @foreach ($inputs as $input)
                                                    <tr id="input_row_{{ $input->id }}">
                                                        ...
                                                        <td style="text-align: right">{{ number_format($input->debit, 2) }}
                                                        </td>
                                                        <td style="text-align: right">
                                                            {{ number_format($input->credit, 2) }}</td>
                                                        <td class="center">
                                                            <a title="Bankstatement Delete"
                                                                class="fa fa-trash-o bigger-130 red"
                    ...
                    success: res => {
                        ...
                        if (res.status == 200) {
                            $.each(res.codes, function(i, v) {
                                opt += '<option value="' + v.id + '" data-gst="' + v.gst_code +
                                    '" data-type="' + v.type + '" data-code="' + parseInt(v.code /
                                        100000) + '">' + v.name + ' => ' + v.code + '</option>'
                            });
            ...
            $('#add').click(function() {
                ...
                request.done(function(response) {
                    let body = `<tr id="input_row_${response.id}">` +
                        ...
                        '<td class="debit" style="text-align: right">' + parseFloat(response.debit).toFixed(2) +
                        '</td>' +
                        '<td class="credit" style="text-align: right">' + parseFloat(response.credit).toFixed(
                        2) + '</td>' +
                        '<td class="center">' +
