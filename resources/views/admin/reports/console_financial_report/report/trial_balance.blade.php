<div class="reportH mt-5">
    ...
    <div class="col-md-8 col-lg-offset-2">
        <table class="table table-bordered">
            <thead>
                <tr>
                    <td class="text-center" style="width:10%">Account Code</td>
                    <td class="text-center" style="width:50%">Account Name</td>
                    <td class="text-center t-right" style="width:20%">Debit</td>
                    <td class="text-center t-right" style="width:20%">Credit</td>
                </tr>
            </thead>
            <tbody>
                @php
