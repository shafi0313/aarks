    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="dep-print-11" align="center">
                <div class="col-lg-12 text-center dep_title"style="display: block; margin-bottom: 20px;">
                ...
                <table class="table table-hover table-bordered table-sm dep-tbl" style="width:100%;">
                    <thead>
                        <tr>
                            <th style="text-align:center; width: 175px" rowspan="2">Asset Name</th>
