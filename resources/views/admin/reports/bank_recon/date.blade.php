                    ...
                    <div class="row">
                        <div class="col-xs-12">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="glyphicon glyphicon-align-justify"></i> Clients Detail
                                        <strong class="pull-right">
                                            <a class="back" href=""><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                                        </strong>
                                    </h3>
                                </div>
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body" style="padding:0px;">
                                    <form action="{{ route('cash_basis.report') }}" method="get" autocomplete="off">
                                        {{-- <input type="hidden" name="proId" value="{{$profession->id}} " /> --}}
