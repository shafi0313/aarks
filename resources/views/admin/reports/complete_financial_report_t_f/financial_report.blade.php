        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>Reports</li>
                    <li>Complete Financial Report T Form</li>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    action="{{ route('complete_financial_report_tf.report', ['client' => $client->id, 'profession' => $profession->id]) }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4" align="left">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="statement_of_chanes_in_equity"
                                                        value="1">
                                        ...
                                        <div class="col-md-4" align="left">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="notes_to_financial_statements"
                                                        value="1">
