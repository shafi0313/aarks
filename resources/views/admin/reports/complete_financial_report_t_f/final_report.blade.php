            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-lg-2 pull-right">
                        ...
                        <a target="_blank"
                            href="{{ route('complete_financial_report_tf.print', [$client->id, $profession->id]) }}{{ str_replace(request()->url(), '', request()->fullUrl()) }}"
                        ...
                        <div class="row" style="height:100vh;display:flex;align-items:center;justify-content:center;">
                            <div class="col-md-12 text-center">
                                ...
                                <h4>ABN {{ $client->abn_number }}{{ $client->charitable_number?', Charitable License Number '.$client->charitable_number:'' }}
                                    {{ $client->iran_number?', IRAN Number '.$client->iran_number:'' }}</h4><br>
