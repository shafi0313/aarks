<div class="reportH mt-5">
    <div class="row justify-content-center">
        ...
        <div class="col-12 cash_flow mt-5" style="margin-top: 35px;">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="text-right">
                            {{number_format($data['cfs_income_cr']->credit, 2)}}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right" style="border-bottom: 2px solid black">
                            {{number_format($data['cfs_expense_dr']->debit, 2)}}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td></td>
                        <td class="text-right">
                            {{number_format($data['cfs_income_cr']->credit - $data['cfs_expense_dr']->debit, 2)}}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
