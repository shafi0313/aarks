...
<div class="row">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title"><i class="glyphicon glyphicon-align-justify"></i> Clients Detail <strong
						class="pull-right"><a class="back" href="https://www.aarks.com.au/Gst_balance_with_period"><i
	...
	<div class="panel panel-success">
		...
		<div class="panel-body" style="padding:0px;">
			<form method="get" action="{{route('cash_periodic.report',[$client->id,$profession->id])}} ">
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="checkbox-inline px-4">
                                <label>
                                    <input type="checkbox" name="peroid_id[]" value="{{$per->id}} ">{{$per->start_date->format(aarks('frontend_date_format'))}} To
