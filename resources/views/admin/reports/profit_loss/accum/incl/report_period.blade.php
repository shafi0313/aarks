    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li>Report</li>
                <li>Console Accumulated P/L GST Inclusive</li>
                <li class="active"></li>
            </ul><!-- /.breadcrumb -->
        </div>
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							<h3>Console Accumulated P/L GST Exclusive</h3>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body" style="padding:0px;">
									<div class="row">
										<form action="{{ route('console_accum.incl_report') }}" method="get" autocomplete="off">
