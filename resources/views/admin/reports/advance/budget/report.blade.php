                                                    ...
                                                    <tr class="with_sales">
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input value="100" class="form-control w-25 text-right"
                                                        ...
                                                        <td style="text-align: right">
                                                            ...
                                                            @endphp
                                                            <span
                                                                class="budget_amount">{{ number_format(abs($sales_budget_amount), 2) }}</span>
                                                        </td>
                                                        <td style="text-align: right">
                                                            <span
                                                                class="actual_amount">{{ number_format(abs($actual), 2) }}</span>
                                                        </td>
                                                        <td style="text-align: right">
                                                            <span
                                                                class="variance_amount">{{ number_format(abs($sales_variance), 2) }}</span>
                                                        </td>
                                                    </tr>
                                                @else
                                                    <tr class="without_sales">
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input class="old_percent form-control w-25 text-right"
                                                                    type="number" disabled
                                                        ...
                                                        <td style="text-align: right">
                                                            ...
                                                            @endphp
                                                            <span
                                                                class="variance_amount">{{ number_format(abs($without_sales_variance), 2) }}</span>
                                                        </td>
                                                    </tr>
                                                @endif
                                            @endif
            ...
            <td><b class="text-danger">{{number_format($other_balance,2)}}</b> </td>
                                        ...
                                        @if ($i == 1)
                                            <tr class="text-right with_sales_total">
                                                ...
                                                <td>
                                                    <b
                                                        class="total_budget">{{ number_format(abs($sum_sales_budget_amount), 2) }}</b>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <b
                                                        class="total_budget">{{ number_format(abs($sum_sales_variance), 2) }}</b>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
                                    <tr class="text-right without_sales_total">
                                        ...
                                        <td>
                                            <b
                                                class="total_budget">{{ number_format($sum_without_sales_budget_amount, 2) }}</b>
                                        </td>
                                        <td>
            ...
            $('.with_sales').each(function() {
                ...
                $input.on('keyup', function() {
                    ...
                    if ($this.hasClass('with_sales_percent')) {
                        ...
                        $this.closest('tr').find('td').eq(5).find('.budget_amount').text(Math.abs(
                            $amount).toFixed(2)).val($amount.toFixed(2));
                        var $total = 0;
            ...
            $('.without_sales').each(function() {
                ...
                $input.on('keyup', function() {
                    ...
                    if (!$this.hasClass('with_sales_percent')) {
                        ...
                        $('.without_sales_total').find('.total_budget').text(Math.abs($total)
                            .toFixed(2)).val($total.toFixed(2));
                        getBudgetPl();
                    }
                });
            });
