<table class="table" style="margin: 10px;">
    ...
    <tr>
        ...
        $oblType = $obl_balance < 0 ? 'Dr' : 'Cr' ; } @endphp @endif <td>{{abs_number($obl_balance) . ' ' .$oblType}}
            </td>
    </tr>
    ...
    $blncType = $blnc < 0 ? 'Dr' : 'Cr' ; } elseif($gen_ledger->balance_type == 1){
        $blncType = $blnc < 0 ? 'Cr' : 'Dr' ; } @endphp <tr>
