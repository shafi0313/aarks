                            ...
                            <div class="panel panel-primary">
                                ...
                                <form action="{{route('gst_recon.store', [$client->id,$profession->id,$period->id])}}"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-hqnx">
                                                        ...
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                            id="oct_dec_g1_diff_inp" value="{{nF2($re_g1_oct_dec_diff)}}">
                                                    </td>
                                                    ...
                                                    <td class="tg-thn2">
                                                        ...
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                            id="jan_mar_g1_diff_inp" value="{{nF2($re_g1_jan_mar_diff)}}">
                                                    </td>
                                                    ...
                                                    <td class="tg-darx">
                                                        ...
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                            id="apr_jun_g1_diff_inp" value="{{nF2($re_g1_apr_jun_diff)}}">
                                                    </td>

                                                    <td class="tg-be25">
                                                        {{$total_g1 = abs($income->sum('gross_amount'))}}
                                                        <input type="hidden" id="g1_total" value="{{nF2($total_g1)}}">
                                                    </td>
                                                    <td class="tg-5q6i">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        ...
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                            id="jul_sep_g3_diff_inp" value={{nF2($re_g3_jul_sep_diff)}}>
                                                    </td>
                                                    <td class="tg-4o99">
                                                        {{$oct_dec_g3_gl =
                                                        ...
                                                        <input type="hidden" name="oct_dec_gl[]" id="oct_dec_g3_gl"
                                                            value="{{nF2($oct_dec_g3_gl)}}">
                                                    </td>
                                                    <td class="tg-lshw">
                                                        <input type="number" step="any" name="oct_dec_ato[]"
                                                            data-total="g3" data-id="oct_dec_g3" id="oct_dec_g3_ato"
                                                            class="form-control g3_ato"
                                                            value="{{old('oct_dec_ato')??nF2($re_g3_oct_dec_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                        ...
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                            id="oct_dec_g3_diff_inp" value={{nF2($re_g3_oct_dec_diff)}}>
                                                    </td>
                                                    <td class="tg-o5ew">
                                                        {{$jan_mar_g3_gl =
                                                        ...
                                                        <input type="hidden" name="jan_mar_gl[]" id="jan_mar_g3_gl"
                                                            value="{{nF2($jan_mar_g3_gl)}}">
                                                    </td>
                                                    <td class="tg-7169">
                                                        <input type="number" step="any" name="jan_mar_ato[]"
                                                            data-total="g3" data-id="jan_mar_g3" id="jan_mar_g3_ato"
                                                            class="form-control g3_ato"
                                                            value="{{old('jan_mar_ato')??nF2($re_g3_jan_mar_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                        ...
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                            id="jan_mar_g3_diff_inp" value={{nF2($re_g3_jan_mar_diff)}}>
                                                    </td>
                                                    <td class="tg-9459">
                                                        {{$apr_jun_g3_gl =
                                                        ...
                                                        <input type="hidden" name="apr_jun_gl[]" id="apr_jun_g3_gl"
                                                            value="{{nF2($apr_jun_g3_gl)}}">
                                                    </td>
                                                    <td class="tg-q8dw">
                                                        <input type="number" step="any" name="apr_jun_ato[]"
                                                            data-total="g3" data-id="apr_jun_g3" id="apr_jun_g3_ato"
                                                            class="form-control g3_ato"
                                                            value="{{old('apr_jun_ato')??nF2($re_g3_apr_jun_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                        ...
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                            id="apr_jun_g3_diff_inp" value={{nF2($re_g3_apr_jun_diff)}}>
                                                    </td>
                                                    <td class="tg-be25">
                                                        {{$total_g3 = abs($incomeNonGst->sum('net_amount'))}}
                                                        <input type="hidden" id="g3_total" value="{{nF2($total_g3)}}">
                                                    </td>
                                                    <td class="tg-5q6i">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-kahv">
                                                        <input type="number" step="any" name="jul_sep_ato[]"
                                                            ...
                                                            value="{{old('jul_sep_ato')??nF2($re_1a_jul_sep_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                        ...
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                            id="jul_sep_1a_diff_inp" value="{{nF2($re_1a_jul_sep_diff)}}">
                                                    </td>
                                                    <td class="tg-4o99">
                                                        ...
                                                        <input type="hidden" name="oct_dec_gl[]" id="oct_dec_1a_gl"
                                                            value="{{nF2($oct_dec_1a_gl)}}">
                                                    </td>
                                                    <td class="tg-lshw">
                                                        <input type="number" step="any" name="oct_dec_ato[]"
                                                            data-total="1a" data-id="oct_dec_1a" id="oct_dec_1a_ato"
                                                            class="form-control 1a_ato"
                                                            value="{{old('oct_dec_ato')??nF2($re_1a_oct_dec_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                        ...
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                            id="oct_dec_1a_diff_inp" value="{{nF2($re_1a_oct_dec_diff)}}">
                                                    </td>
                                                    <td class="tg-o5ew">
                                                        ...
                                                        <input type="hidden" name="jan_mar_gl[]" id="jan_mar_1a_gl"
                                                            value="{{nF2($jan_mar_1a_gl)}}">
                                                    </td>
                                                    <td class="tg-7169">
                                                        <input type="number" step="any" name="jan_mar_ato[]"
                                                            data-total="1a" data-id="jan_mar_1a" id="jan_mar_1a_ato"
                                                            class="form-control 1a_ato"
                                                            value="{{old('jan_mar_ato')??nF2($re_1a_jan_mar_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                        ...
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                            id="jan_mar_1a_diff_inp" value="{{nF2($re_1a_jan_mar_diff)}}">
                                                    </td>
                                                    <td class="tg-9459">
                                                        ...
                                                        <input type="hidden" name="apr_jun_gl[]" id="apr_jun_1a_gl"
                                                            value="{{nF2($apr_jun_1a_gl)}}">
                                                    </td>
                                                    <td class="tg-q8dw">
                                                        <input type="number" step="any" name="apr_jun_ato[]"
                                                            data-total="1a" data-id="apr_jun_1a" id="apr_jun_1a_ato"
                                                            class="form-control 1a_ato"
                                                            value="{{old('apr_jun_ato')??nF2($re_1a_apr_jun_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                        ...
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                            id="apr_jun_1a_diff_inp" value="{{nF2($re_1a_apr_jun_diff)}}">
                                                    </td>
                                                    <td class="tg-be25">
                                                        {{$total_1a = abs($income->sum('gst_cash_amount'))}}
                                                        <input type="hidden" id="1a_total" value="{{nF2($total_1a)}}">
                                                    </td>
                                                    <td class="tg-5q6i">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-wtqs">
                                                        ...
                                                        <input type="hidden" name="jul_sep_gl[]" id="jul_sep_g11_gl"
                                                            value="{{nF2($jul_sep_g11_gl)}}">
                                                    </td>
                                                    <td class="tg-kahv">
                                                        <input type="number" step="any" name="jul_sep_ato[]"
                                                            data-total="g11" data-id="jul_sep_g11" id="jul_sep_g11_ato"
                                                            class="form-control g11_ato"
                                                            value="{{old('jul_sep_ato')??nF2($re_g11_jul_sep_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                        ...
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                            id="jul_sep_g11_diff_inp" value="{{nF2($re_g11_jul_sep_diff)}}">
                                                    </td>
                                                    <td class="tg-4o99">
                                                        {{$oct_dec_g11_gl =
                                                        ...
                                                        <input type="hidden" name="oct_dec_gl[]" id="oct_dec_g11_gl"
                                                            value="{{nF2($oct_dec_g11_gl)}}">
                                                    </td>
                                                    <td class="tg-lshw">
                                                        <input type="number" step="any" name="oct_dec_ato[]"
                                                            data-total="g11" data-id="oct_dec_g11" id="oct_dec_g11_ato"
                                                            class="form-control g11_ato"
                                                            value="{{old('oct_dec_ato')??nF2($re_g11_oct_dec_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                        ...
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                            id="oct_dec_g11_diff_inp" value="{{nF2($re_g11_oct_dec_diff)}}">
                                                    </td>
                                                    <td class="tg-o5ew">
                                                        {{$jan_mar_g11_gl =
                                                        ...
                                                        <input type="hidden" name="jan_mar_gl[]" id="jan_mar_g11_gl"
                                                            value="{{nF2($jan_mar_g11_gl)}}">
                                                    </td>
                                                    <td class="tg-7169">
                                                        <input type="number" step="any" name="jan_mar_ato[]"
                                                            data-total="g11" data-id="jan_mar_g11" id="jan_mar_g11_ato"
                                                            class="form-control g11_ato"
                                                            value="{{old('jan_mar_ato')??nF2($re_g11_jan_mar_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                        ...
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                            id="jan_mar_g11_diff_inp" value="{{nF2($re_g11_jan_mar_diff)}}">
                                                    </td>
                                                    <td class="tg-9459">
                                                        {{$apr_jun_g11_gl =
                                                        ...
                                                        <input type="hidden" name="apr_jun_gl[]" id="apr_jun_g11_gl"
                                                            value="{{nF2($apr_jun_g11_gl)}}">
                                                    </td>
                                                    <td class="tg-q8dw">
                                                        <input type="number" step="any" name="apr_jun_ato[]"
                                                            data-total="g11" data-id="apr_jun_g11" id="apr_jun_g11_ato"
                                                            class="form-control g11_ato"
                                                            value="{{old('apr_jun_ato')??nF2($re_g11_apr_jun_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                        ...
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                            id="apr_jun_g11_diff_inp" value="{{nF2($re_g11_apr_jun_diff)}}">
                                                    </td>
                                                    <td class="tg-be25">
                                                        {{$total_g11 = abs($expense_code->sum('gross_amount'))}}
                                                        <input type="hidden" id="g11_total" value="{{nF2($total_g11)}}">
                                                    </td>
                                                    <td class="tg-5q6i">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-be25">
                                                        ...
                                                        <input type="hidden" id="1b_total" value="{{nF2($total_1b)}}">
                                                    </td>
                                                    <td class="tg-5q6i">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-o5ew">
                                                        ...
                                                        <input type="hidden" name="jan_mar_gl[]" id="jan_mar_w1_gl"
                                                            value="{{nF2($jan_mar_w1_gl)}}">
                                                    </td>
                                                    <td class="tg-7169">
                                                        <input type="number" step="any" name="jan_mar_ato[]"
                                                            data-total="w1" data-id="jan_mar_w1" id="jan_mar_w1_ato"
                                                            class="form-control w1_ato"
                                                            value="{{old('jan_mar_ato')??nF2($re_w1_jan_mar_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                    ...
                                                    <td class="tg-9459">
                                                        ...
                                                        <input type="hidden" name="apr_jun_gl[]" id="apr_jun_w1_gl"
                                                            value="{{nF2($apr_jun_w1_gl)}}">
                                                    </td>
                                                    <td class="tg-q8dw">
                                                        <input type="number" step="any" name="apr_jun_ato[]"
                                                            data-total="w1" data-id="apr_jun_w1" id="apr_jun_w1_ato"
                                                            class="form-control w1_ato"
                                                            value="{{old('apr_jun_ato')??nF2($re_w1_apr_jun_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                    ...
                                                    <td class="tg-be25">
                                                        ...
                                                        <input type="hidden" id="w1_total" value="{{nF2($total_w1)}}">
                                                    </td>
                                                    <td class="tg-5q6i">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-darx">
                                                        ...
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                            id="apr_jun_w2_diff_inp" value="{{nF2($re_w2_apr_jun_diff)}}">
                                                    </td>
                                                    <td class="tg-be25">
                                                        {{$total_w2 = abs($w2->sum('gross_amount'))}}
                                                        <input type="hidden" id="w2_total" value="{{nF2($total_w2)}}">
                                                    </td>
                                                    <td class="tg-5q6i">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-wtqs">
                                                        ...
                                                        <input type="hidden" name="jul_sep_gl[]" id="jul_sep_g10_gl"
                                                            value="{{nF2($jul_sep_g10_gl)}}">
                                                    </td>
                                                    <td class="tg-kahv">
                                                        <input type="number" step="any" name="jul_sep_ato[]"
                                                            data-total="g10" data-id="jul_sep_g10" id="jul_sep_g10_ato"
                                                            class="form-control g10_ato"
                                                            value="{{old('jul_sep_ato')??nF2($re_g10_jul_sep_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                        ...
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                            id="jul_sep_g10_diff_inp" value="{{nF2($re_g10_jul_sep_diff)}}">
                                                    </td>
                                                    <td class="tg-4o99">
                                                        {{$oct_dec_g10_gl = abs($asset->whereBetween('trn_date',
                                                        [$oct, $dec])->sum('gross_amount'))}}
                                                        <input type="hidden" name="oct_dec_gl[]" id="oct_dec_g10_gl"
                                                            value="{{nF2($oct_dec_g10_gl)}}">
                                                    </td>
                                                    <td class="tg-lshw">
                                                        <input type="number" step="any" name="oct_dec_ato[]"
                                                            data-total="g10" data-id="oct_dec_g10" id="oct_dec_g10_ato"
                                                            class="form-control g10_ato"
                                                            value="{{old('oct_dec_ato')??nF2($re_g10_oct_dec_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                        ...
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                            id="oct_dec_g10_diff_inp" value="{{nF2($re_g10_oct_dec_diff)}}">
                                                    </td>
                                                    <td class="tg-o5ew">
                                                        {{$jan_mar_g10_gl = abs($asset->whereBetween('trn_date',
                                                        [$jan, $mar])->sum('gross_amount'))}}
                                                        <input type="hidden" name="jan_mar_gl[]" id="jan_mar_g10_gl"
                                                            value="{{nF2($jan_mar_g10_gl)}}">
                                                    </td>
                                                    <td class="tg-7169">
                                                        <input type="number" step="any" name="jan_mar_ato[]"
                                                            data-total="g10" data-id="jan_mar_g10" id="jan_mar_g10_ato"
                                                            class="form-control g10_ato"
                                                            value="{{old('jan_mar_ato')??nF2($re_g10_jan_mar_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                        ...
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                            id="jan_mar_g10_diff_inp" value="{{nF2($re_g10_jan_mar_diff)}}">
                                                    </td>
                                                    <td class="tg-9459">
                                                        {{$apr_jun_g10_gl = abs($asset->whereBetween('trn_date',
                                                        [$apr, $june])->sum('gross_amount'))}}
                                                        <input type="hidden" name="apr_jun_gl[]" id="apr_jun_g10_gl"
                                                            value="{{nF2($apr_jun_g10_gl)}}">
                                                    </td>
                                                    <td class="tg-q8dw">
                                                        <input type="number" step="any" name="apr_jun_ato[]"
                                                            data-total="g10" data-id="apr_jun_g10" id="apr_jun_g10_ato"
                                                            class="form-control g10_ato"
                                                            value="{{old('apr_jun_ato')??nF2($re_g10_apr_jun_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                        ...
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                            id="apr_jun_g10_diff_inp" value="{{nF2($re_g10_apr_jun_diff)}}">
                                                    </td>
                                                    <td class="tg-be25">
                                                        {{$total_g10 = abs($asset->sum('gross_amount'))}}
                                                        <input type="hidden" id="g10_total" value="{{nF2($total_g10)}}">
                                                    </td>
                                                    <td class="tg-5q6i">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        ...
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                            id="jul_sep_9_diff_inp" value="{{nF2($re_9_jul_sep_diff)}}">
                                                    </td>
                                                    <td class="tg-4o99">
                                                    ...
                                                    <td class="tg-lshw">
                                                        <input type="number" step="any" name="oct_dec_ato[]"
                                                            ...
                                                            class="form-control 9_ato"
                                                            value="{{old('oct_dec_ato')??nF2($re_9_oct_dec_ato)}}"
                                                            placeholder="0.00">
                                                    </td>
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                    ...
                                                    <td class="tg-darx">
                                                        ...
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                            id="apr_jun_9_diff_inp" value="{{nF2($re_9_apr_jun_diff)}}">
                                                    </td>
                                                    <td class="tg-be25">
                                                        {{$total_9 = abs($total_1a - $total_1b)}}
                                                        <input type="hidden" id="9_total" value="{{nF2($total_9)}}">
                                                    </td>
                                                    <td class="tg-5q6i">
                                        ...
                                        <table class="tax_table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 110px" class="text-center">P/L amt as per complete
                                                        report</th>
                                                    <th style="width: 110px" class="text-center">P/L as per to ATO</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="report[]"
                                                            value="{{nFA2($totalCredit)}}">
                                                    </td>
                                                    <td>
                                                        <span class="g1 tax_g1 tax_ato_g1">{{nF2($sales_bf_ato)}}</span>
                                                        <input type="hidden" name="ato[]" value="{{nF2($sales_bf_ato)}}"
                                                            class="g1">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="1a tax_1a tax_ato_1a">{{nF2($sales_ato)}}</span>
                                                        <input type="hidden" name="ato[]" value="{{nF2($sales_ato)}}"
                                                            class="1a">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="tax_gl_1a_g1">{{nF2(abs($total_g1) -
                                                            abs($total_1a))}}</span>
                                                        <input type="hidden" name="bas[]"
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="report[]"
                                                            value="{{nFA2($totalIncome)}}">
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="1a_g1 tax_1a_g1 tax_ato_1a_g1">{{nF2($sales_af_ato)}}</span>
                                                        <input type="hidden" name="ato[]" value="{{nF2($sales_af_ato)}}"
                                                            class="1a_g1">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="bas[]"
                                                            value="{{nFA2($total_g11)}}">
                                                    </td>
                                                    <td>
                                                        <span class="tax_pl_g11">{{nFA2($totalDebit)}}</span>
                                                        <input type="hidden" name="report[]"
                                                            value="{{nFA2($totalDebit)}}">
                                                    </td>
                                                    <td>
                                                        <span class="g11 tax_g11 tax_ato_g11">{{nF2($exp_bf_ato)}}</span>
                                                        <input type="hidden" name="ato[]" value="{{nF2($exp_bf_ato)}}"
                                                            class="g11">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="ato[]" value="{{nF2($exp_ato)}}"
                                                            class="1b">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="tax_gl_g11_1b">{{nF2(abs($total_g11) -
                                                            abs($total_1b)+abs($total_w1))}}</span>
                                                        <input type="hidden" name="bas[]"
                                                            value="{{nF2(abs($total_g11) - abs($total_1b)+abs($total_w1))}}">
                                                    </td>
                                                    <td>
                                                        <span class="tax_pl_g11_1b">{{nFA2($totalExpense)}}</span>
                                                        <input type="hidden" name="report[]"
                                                            value="{{nFA2($totalExpense)}}">
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="g11_1b tax_g11_1b tax_ato_g11_1b">{{nF2($exp_af_ato)}}</span>
                                                        <input type="hidden" name="ato[]" value="{{nF2($exp_af_ato)}}"
                                                            class="g11_1b">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="w1 tax_w1 tax_ato_w1">{{nF2($wages_ato)}}</span>
                                                        <input type="hidden" name="ato[]" value="{{nF2($wages_ato)}}"
                                                            class="w1">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="w2 tax_w2 tax_ato_w2">{{nF2($payg_ato)}}</span>
                                                        <input type="hidden" name="ato[]" value="{{nF2($payg_ato)}}"
                                                            class="w2">
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="col-md-6" style="padding-top: 220px">
                                        ...
                                        <button type="button" class="btn" style="background: rgb(42, 0, 158) !important; border-color: rgb(42, 0, 158) !important;"data-toggle="modal" data-target="#reconNote">Notes
                                        </button>
                                        ...
                                        <input type="submit" name="type" value="Export to excel" class="btn"
                                        ...
                                        <input type="submit" name="type" value="Post" class="btn btn-warning">
                                        @endif
                                        <!-- Button trigger modal -->
    ...
    <div class="modal fade" id="reconNote" tabindex="-1" role="dialog" aria-labelledby="reconNoteLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('gst_recon.save_note',[$client->id,$profession->id])}}" method="post" id="saveNote">
                    @csrf
