                                        ...
                                        <table class="tg">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                            id="jul_sep_g1_diff">{{$re_g1_jul_sep_diff}}</span>
                                                    ...
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                            id="oct_dec_g1_diff">{{$re_g1_oct_dec_diff}}</span>
                                                    ...
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                            id="jan_mar_g1_diff">{{$re_g1_jan_mar_diff}}</span>
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                            id="jan_mar_g1_diff_inp" value="{{$re_g1_jan_mar_diff}}">
                                                    </td>
                                                    ...
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                            id="apr_jun_g1_diff">{{$re_g1_apr_jun_diff}}</span>
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                            id="apr_jun_g1_diff_inp" value="{{$re_g1_apr_jun_diff}}">
                                                    </td>
                                                    ...
                                                    <td class="tg-5q6i">
                                                        <span class="g1">{{$re_g1_total}}</span>
                                                    </td>
                                                    <td class="tg-xszb">
                                                        <span class="g1_diff">{{$re_g1_total_diff}}</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                            id="jul_sep_g3_diff">{{$re_g3_jul_sep_diff}}</span>
                                                    ...
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                            id="oct_dec_g3_diff">{{$re_g3_oct_dec_diff}}</span>
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                    ...
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                            id="jan_mar_g3_diff">{{$re_g3_jan_mar_diff}}</span>
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                    ...
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                            id="apr_jun_g3_diff">{{$re_g3_apr_jun_diff}}</span>
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                    ...
                                                    <td class="tg-5q6i">
                                                        <span class="g3">{{$re_g3_total}}</span>
                                                    </td>
                                                    <td class="tg-xszb">
                                                        <span class="g3_diff">{{$re_g3_total_diff}}</span>
                                                    </td>
                                                </tr>
                                                {{-- 1A --}}
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                            id="jul_sep_1a_diff">{{$re_1a_jul_sep_diff}}</span>
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                    ...
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                            id="oct_dec_1a_diff">{{$re_1a_oct_dec_diff}}</span>
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                    ...
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                            id="jan_mar_1a_diff">{{$re_1a_jan_mar_diff}}</span>
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                    ...
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                            id="apr_jun_1a_diff">{{$re_1a_apr_jun_diff}}</span>
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                    ...
                                                    <td class="tg-5q6i">
                                                        <span class="1a">{{$re_1a_total}}</span>
                                                    </td>
                                                    <td class="tg-xszb">
                                                        <span class="1a_diff">{{$re_1a_total_diff}}</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                            id="jul_sep_g11_diff">{{$re_g11_jul_sep_diff}}</span>
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                            id="jul_sep_g11_diff_inp" value="{{$re_g11_jul_sep_diff}}">
                                                    </td>
                                                    <td class="tg-4o99">
                                                        {{$oct_dec_g11_gl =
                                                    ...
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                            id="oct_dec_g11_diff">{{$re_g11_oct_dec_diff}}</span>
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                            id="oct_dec_g11_diff_inp" value="{{$re_g11_oct_dec_diff}}">
                                                    </td>
                                                    <td class="tg-o5ew">
                                                        {{$jan_mar_g11_gl =
                                                    ...
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                            id="jan_mar_g11_diff">{{$re_g11_jan_mar_diff}}</span>
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                            id="jan_mar_g11_diff_inp" value="{{$re_g11_jan_mar_diff}}">
                                                    </td>
                                                    <td class="tg-9459">
                                                        {{$apr_jun_g11_gl =
                                                    ...
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                            id="apr_jun_g11_diff">{{$re_g11_apr_jun_diff}}</span>
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                    ...
                                                    <td class="tg-5q6i">
                                                        <span class="g11">{{$re_g11_total}}</span>
                                                    </td>
                                                    <td class="tg-xszb">
                                                        <span class="g11_diff">{{$re_g11_total_diff}}</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                            id="jul_sep_1b_diff">{{$re_1b_jul_sep_diff}}</span>
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                    ...
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                            id="oct_dec_1b_diff">{{$re_1b_oct_dec_diff}}</span>
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                    ...
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                            id="jan_mar_1b_diff">{{$re_1b_jan_mar_diff}}</span>
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                    ...
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                            id="apr_jun_1b_diff">{{$re_1b_apr_jun_diff}}</span>
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                    ...
                                                    <td class="tg-5q6i">
                                                        <span class="1b">{{$re_1b_total}}</span>
                                                    </td>
                                                    <td class="tg-xszb">
                                                        <span class="1b_diff">{{$re_1b_total_diff}}</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                            id="jul_sep_w1_diff">{{$re_w1_jul_sep_diff}}</span>
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                    ...
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                            id="oct_dec_w1_diff">{{$re_w1_oct_dec_diff}}</span>
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                    ...
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                            id="jan_mar_w1_diff">{{$re_w1_jan_mar_diff}}</span>
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                    ...
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                            id="apr_jun_w1_diff">{{$re_w1_apr_jun_diff}}</span>
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                    ...
                                                    <td class="tg-5q6i">
                                                        <span class="w1">{{$re_w1_total}}</span>
                                                    </td>
                                                    <td class="tg-xszb">
                                                        <span class="w1_diff">{{$re_w1_total_diff}}</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                            id="jul_sep_w2_diff">{{$re_w2_jul_sep_diff}}</span>
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                    ...
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                            id="oct_dec_w2_diff">{{$re_w2_oct_dec_diff}}</span>
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                    ...
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                            id="jan_mar_w2_diff">{{$re_w2_jan_mar_diff}}</span>
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                    ...
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                            id="apr_jun_w2_diff">{{$re_w2_apr_jun_diff}}</span>
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                    ...
                                                    <td class="tg-5q6i">
                                                        <span class="w2">{{$re_w2_total}}</span>
                                                    </td>
                                                    <td class="tg-xszb">
                                                        <span class="w2_diff">{{$re_w2_total_diff}}</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                            id="jul_sep_g10_diff">{{$re_g10_jul_sep_diff}}</span>
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                    ...
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                            id="oct_dec_g10_diff">{{$re_g10_oct_dec_diff}}</span>
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                    ...
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                            id="jan_mar_g10_diff">{{$re_g10_jan_mar_diff}}</span>
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                    ...
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                            id="apr_jun_g10_diff">{{$re_g10_apr_jun_diff}}</span>
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                    ...
                                                    <td class="tg-5q6i">
                                                        <span class="g10">{{$re_g10_total}}</span>
                                                    </td>
                                                    <td class="tg-xszb">
                                                        <span class="g10_diff">{{$re_g10_total_diff}}</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-j8ny">
                                                        <span class="jul_sep_diff"
                                                            id="jul_sep_9_diff">{{$re_9_jul_sep_diff}}</span>
                                                        <input type="hidden" name="jul_sep_diff[]"
                                                    ...
                                                    <td class="tg-hqnx">
                                                        <span class="oct_dec_diff"
                                                            id="oct_dec_9_diff">{{$re_9_oct_dec_diff}}</span>
                                                        <input type="hidden" name="oct_dec_diff[]"
                                                    ...
                                                    <td class="tg-thn2">
                                                        <span class="jan_mar_diff"
                                                            id="jan_mar_9_diff">{{$re_9_jan_mar_diff}}</span>
                                                        <input type="hidden" name="jan_mar_diff[]"
                                                    ...
                                                    <td class="tg-darx">
                                                        <span class="apr_jun_diff"
                                                            id="apr_jun_9_diff">{{$re_9_apr_jun_diff}}</span>
                                                        <input type="hidden" name="apr_jun_diff[]"
                                                    ...
                                                    <td class="tg-5q6i">
                                                        <span class="9">{{$re_9_total}}</span>
                                                    </td>
                                                    <td class="tg-xszb">
                                                        <span class="9_diff">{{$re_9_total_diff}}</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="ato[]" value="{{$sales_bf_ato}}"
                                                            class="g1">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="1a tax_1a tax_ato_1a">{{$sales_ato}}</span>
                                                        <input type="hidden" name="ato[]" value="{{$sales_ato}}"
                                                            class="1a">
                                                    </td>
                                                    <td>
                                                        <span class="tax_diff_1a">{{$sales_diff}}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="1a_g1 tax_1a_g1 tax_ato_1a_g1">{{$sales_af_ato}}</span>
                                                        <input type="hidden" name="ato[]" value="{{$sales_af_ato}}"
                                                            class="1a_g1">
                                                    </td>
                                                    <td>
                                                        <span class="tax_diff_1a_g1">{{$sales_af_diff}}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="ato[]" value="{{$exp_bf_ato}}"
                                                            class="g11">
                                                    </td>
                                                    <td>
                                                        <span class="tax_diff_g11">{{$exp_bf_diff}}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="1b tax_1b tax_ato_1b">{{$exp_ato}}</span>
                                                        <input type="hidden" name="ato[]" value="{{$exp_ato}}"
                                                            class="1b">
                                                    </td>
                                                    <td>
                                                        <span class="tax_diff_1b">{{$exp_diff}}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="g11_1b tax_g11_1b tax_ato_g11_1b">{{$exp_af_ato}}</span>
                                                        <input type="hidden" name="ato[]" value="{{$exp_af_ato}}"
                                                            class="g11_1b">
                                                    </td>
                                                    <td>
                                                        <span class="tax_diff_g11_1b">{{$exp_af_diff}}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Total wages</td>
                                                    ...
                                                    <td>
                                                        <span class="w1 tax_w1 tax_ato_w1">{{$wages_ato}}</span>
                                                        <input type="hidden" name="ato[]" value="{{$wages_ato}}"
                                                            class="w1">
                                                    </td>
                                                    <td>
                                                        <span class="tax_diff_w1">{{$wages_diff}}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>PAYG</td>
                                                    ...
                                                    <td>
                                                        <span class="w2 tax_w2 tax_ato_w2">{{$payg_ato}}</span>
                                                        <input type="hidden" name="ato[]" value="{{$payg_ato}}"
                                                            class="w2">
                                                    </td>
                                                    <td>
                                                        <span class="tax_diff_w2">{{$payg_diff}}</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
