<div class="reportH mt-5">
    ...
    <div class="row justify-content-center" style="margin-top: 35px;">
        ...
        <div class="col-md-8 cash_flow">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <td class="center" style="width:50%;text-align:center">Cheque Account</td>
                        <td class="center t-right" style="width:20%">{{$data['year']-1}}</td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-right">
                            @php($pre_opening_bl = $data['pre_srp_opening_ledger']->debit -
                            $data['pre_srp_opening_ledger']->credit)
                            {{number_format($pre_opening_bl, 2)}}
                        </td>
                        <td class="text-right">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            {{number_format($data['pre_srp_ledger']->debit, 2)}}
                        </td>
                        <td class="text-right">
                    ...
                    <tr style="font-weight: bold;">
                        ...
                        <td class="text-right">
                            ...
                            {{number_format($pre_opening_bl + $data['pre_srp_ledger']->debit, 2)}}
                            </span>
                        </td>
                        <td class="text-right">
                            <span style="border-top:1px solid">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            {{number_format($data['pre_srp_ledger']->credit, 2)}}
                        </td>
                        <td class="text-right">
                    ...
                    <tr style="font-weight: bold;">
                        ...
                        <td class="text-right">
                            <span style="border-top:1px solid;float: right;">
                            {{number_format($data['pre_srp_ledger']->credit, 2)}}
                            </span>
                        </td>
                        <td class="text-right">
                    ...
                    <tr style="font-weight: bold;">
                        ...
                        <td class="text-right">
                            <span style="border-bottom-style:double;border-top:1px solid;float: right;">
                            {{number_format($pre_opening_bl + $data['pre_srp_ledger']->debit -
                            $data['pre_srp_ledger']->credit, 2)}}
                            </span>
                        </td>
                        <td class="text-right">
                            <span style="border-bottom-style:double;border-top:1px solid;float: right;">
                            {{number_format($opening_bl + $data['srp_ledger']->debit - $data['srp_ledger']->credit, 2)}}
                            </span>
                        </td>
                    </tr>
                </tbody>
