						...
						<div class="col-xs-12">
							...
							<div class="panel panel-success">
								<div class="panel-heading">
									<h3 class="panel-title">Report for the Activity : <strong></strong></h3>
								</div>
							...
							<form action="{{route('comperative_financial_report_report', $client->id)}}" method="get" autocomplete="off">
								...
								<div class="col-md-5">
									<div class="row">
										<div class="panel-body" style="padding:0px;">
											...
											<div class="col-md-4">
												<div class="row">
													<button type="submit" class="btn btn-info" style="border:none; padding:7px;">Show Report</button>
												</div>
											</div>
										</div>
									</div>
