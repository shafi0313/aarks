...
<div class="modal fade" tabindex="-1" role="dialog" id="disposemodal" style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="assetupdate" method="POST" autocomplete="off" action="{{route('depreciation.disposal.postAsset',$disposal->id)}}">
            @csrf
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title assetitle">{{$disposal->asset_name}}</h4>
                </div>
