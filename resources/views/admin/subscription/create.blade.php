            ...
            <div class="row justify-content-center text-center">
                <div class="col-md-12">
                    <div class="section-title">
                        <h2 class="title">Create Pricing Plan</h2>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                    ...
                    <form action="{{route('plan.store')}}" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input step="any" type="number" name="amount" id="amount" value="{{old('amount')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input step="1" type="number" name="interval" id="interval"
                                        value="{{old('interval')}}" placeholder="Enter Interval (day)" autofocus
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input step="1" type="number" name="sales_quotation" id="sales_quotation"
                                        value="{{old('sales_quotation')}}" placeholder="Enter Sales Quotation" autofocus
                                        required class="col-xs-10 col-sm-8" />
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input step="1" type="number" name="purchase_quotation" id="purchase_quotation"
                                        value="{{old('purchase_quotation')}}" placeholder="Enter Purchase Quotation"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input step="1" type="number" name="invoice" id="invoice" value="{{old('invoice')}}"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input step="1" type="number" name="bill" id="bill" value="{{old('bill')}}"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input step="1" type="number" name="receipt" id="receipt" value="{{old('receipt')}}"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input step="1" type="number" name="payment" id="payment" value="{{old('payment')}}"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input step="1" type="number" name="payslip" id="payslip" value="{{old('payslip')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <label class="control-label" for="access_report">
                                        <input type="checkbox" name="access_report" id="access_report" value="1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <label class="control-label" for="customer_support">
                                        <input type="checkbox" name="customer_support" id="customer_support" value="1">
