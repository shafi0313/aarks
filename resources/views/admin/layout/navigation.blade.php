<div id="sidebar" class="sidebar responsive ace-save-state">
    ...
    <ul class="nav nav-list">
        ...
        <li
            class="{{ activeNav(['select_method', 'admin.period.*', 'bs_import.*', 'bs_input.*', 'depreciation.*', 'manage_invest.*', 'journal_entry.*']) }}">
            @canany(['admin.period.index', 'admin.bs_import.create', 'admin.bs_input.create',
