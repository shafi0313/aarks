<div id="sidebar" class="sidebar responsive ace-save-state">
    ...
    <ul class="nav nav-list">
        ...
        <li
            ...
            <ul class="submenu">
                ...
                @canany(['admin.user.create', 'admin.role.index'])
                    <li class="{{ activeOpenNav(['user.*', 'role.*']) }}">
                        <a href="#" class="dropdown-toggle">
                            <i class="menu-icon fa fa-caret-right"></i>
                            User Management
                            <b class="arrow fa fa-angle-down"></b>
                ...
                @canany(['admin.account-code.index', 'admin.account-code.create', 'admin.account-code.edit',
                    ...
                    <li class="{{ activeOpenNav(['code','account-code.*','master.*','client_fixed_code.*']) }}">
                        <a href="#" class="dropdown-toggle">
                            <i class="menu-icon fa fa-caret-right"></i>
                            Code
                            <b class="arrow fa fa-angle-down"></b>
                        ...
                        <ul class="submenu">
                            @canany(['admin.account-code.index', 'admin.account-code.create', 'admin.account-code.edit',
                                ...
                                <li class="{{ activeNav(['code','account-code.*']) }}">
                                    <a href="{{ route('code') }}">
                                        <i class="menu-icon fa fa-caret-right"></i>
                                        Account Chart
                                    </a>
                            ...
                            @canany(['admin.master-chart.index', 'admin.master-chart.create', 'admin.master-chart.edit',
                                ...
                                <li class="{{ activeNav('client_fixed_code.*') }}">
                ...
                @endcanany
                @canany(['admin.fuel_tax_cr.index', 'admin.fuel_tax_cr.edit', 'admin.fuel_tax_cr.create',
                    'admin.fuel_tax_cr.delete'])
                    <li class="{{ activeNav('FuelTaxCredit.*') }}">
                ...
                @canany(['admin.coefficients.index', 'admin.coefficients.edit', 'admin.coefficients.create',
                    'admin.coefficients.delete', 'admin.i_tax_table.index', 'admin.i_tax_table.edit',
                    'admin.i_tax_table.create', 'admin.i_tax_table.delete', 'admin.wages.index', 'admin.wages.edit',
                    'admin.wages.create', 'admin.wages.delete', 'admin.superannuation.index', 'admin.superannuation.edit',
                    'admin.superannuation.create', 'admin.superannuation.delete', 'admin.leave.index', 'admin.leave.edit',
                    'admin.leave.create', 'admin.leave.delete', 'admin.deducation.index', 'admin.deducation.edit',
                    'admin.deducation.create', 'admin.deducation.delete'])
                    {{-- <li class="">
                    <a href="#" class="dropdown-toggle">
                        <i class="menu-icon fa fa-caret-right"></i>
                        Manage Payroll
        ...
        @canany(['admin.service.index', 'admin.service.create', 'admin.service.edit', 'admin.service.delete'])
            <li class="{{ activeOpenNav(['service.*']) }}">
                <a href="#" class="dropdown-toggle">
                    <i class="menu-icon fa fa-caret-right"></i>
                    Services
                    <b class="arrow fa fa-angle-down"></b>
                ...
                <ul class="submenu">
                    @can('admin.service.index')
                        <li class="{{ activeNav('service.index') }}">
                    ...
                    @can('admin.service.create')
                        <li class="{{ activeNav('service.create') }}">
    ...
    @canany(['admin.verify_account.index', 'admin.period_lock.index'])
        <!-- Tools -->
        <li class="{{ activeOpenNav(['verify_account.*','period_lock.*']) }}">
            <a href="#" class="dropdown-toggle">
            ...
            <ul class="submenu">
                ...
                @can('admin.period_lock.index')
                    <li class="{{ activeNav('period_lock.*') }}">
    ...
    @canany(['admin.gst_recon.index', 'admin.cash_basis.index', 'admin.accrued_basis.index',
        ...
        'admin.depreciation_report.index', 'admin.consolidated_report.index', 'admin.investment_report.index',
        'admin.ratio_report.index', 'admin.investment_report.index'])
        <li
            class="{{ activeOpenNav([
                'gst_recon.*',
                'cash_basis.*',
