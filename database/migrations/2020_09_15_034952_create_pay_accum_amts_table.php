...
class CreatePayAccumAmtsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pay_accum_amts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pay_accum_amts');
    }
}
