...
class CreateCreditorServiceOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('creditor_service_orders', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('creditor_service_orders');
    }
}
